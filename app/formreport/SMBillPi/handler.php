...
$handler->onBeginProcessData = function ($args) {
	if ($args->connection == "Vending")
        $args->connectionString = "Data Source=202.44.55.96;Initial Catalog=PTT_AdaPos5Tester;Integrated Security=False;User ID=sa;Password=GvFhk@61";
        // $args->connectionString = "Data Source=202.44.55.96;Initial Catalog=DevAdaPTT;Integrated Security=False;User ID=sa;Password=GvFhk@61";
