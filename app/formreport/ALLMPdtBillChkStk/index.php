...
<head>
	...
	<?php
		if(isset($_GET["infor"])){
			$aParamiterMap = array(
				"Lang","CompCode","CompBchCode","BchCode","DocCode"
			);
	...
	<script type="text/javascript">
		function Start() {
			...
			report.dictionary.variables.getByName("SP_tCompCode").valueObject = "<?php echo $aDataMQ["CompCode"]; ?>";
			report.dictionary.variables.getByName("SP_tCmpBch").valueObject = "<?php echo $aDataMQ["CompBchCode"]; ?>";
