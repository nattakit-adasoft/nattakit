	...
	$(document).ready(function () {
		...
		$(".xWAddTimeTableDT").validate({
			...
			submitHandler: function (form) {
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url();?>EticketTimeTable/AddTimeTableDTAjax",
					data: $(".xWAddTimeTableDT").serialize(),
					cache: false,
					success: function (msg) {   
						...
						if (parseInt(msg) != 0) {
							...
							if (nDataId == '1') {
								JSxCallPage('<?php echo base_url()?>EticketTimeTable/EditTimeTableDT/' + msg + '/<?= $nFNTmhID ?>');
							} else if(nDataId == '2') {
...
<form action="" method="post" autocorrect="off" autocapitalize="off" autocomplete="off" class="xWAddTimeTableDT">
		<div class="main-menu">
					...
					<div class="xCNBchVMaster">
						<div class="col-xs-8 col-md-8">
							<ol id="oliMenuNav" class="breadcrumb">
								...
								<li class="xCNLinkClick"><?= language('ticket/timetable/timetable', 'tAddShow') ?></li>
							</ol>
						</div>
		...
		<input type="hidden" name="ohdFNTmhID" id="oetFNTmhID" value="<?= $nFNTmhID; ?>" />
					...
					<div class="row">			
						<div class="col-md-4 col-sm-4 col-xs-12">		
							<div class="form-group" >
								...
								<input type="text" class="form-control" id="oetFTTmdName" name="oetFTTmdName" data-validate="<?= language('ticket/timetable/timetable', 'tPleaseEnterShowName') ?>">
							</div>

							<div class="form-group">
								<label class="xCNLabelFrm"><?= language('ticket/timetable/timetable', 'tShowFrom') ?></label>
								<div class="input-group">
									<input type="text" class="form-control xCNDatepicker xCNInputMaskDate" id="oetFTTmdStartTime" name="oetFTTmdStartTime" data-validate="<?= language('ticket/timetable/timetable', 'tPleaseEnterShowFrom') ?>">
							...
							<div class="form-group">
								...
								<div class="input-group">
									<input type="text" class="form-control xCNDatepicker xCNInputMaskDate" id="oetFTTmdEndTime" name="oetFTTmdEndTime" data-validate="<?= language('ticket/timetable/timetable', 'tPleaseEnterShowTo') ?>">
									<span class="input-group-btn">
