    ...
    $(function () {
        ...
        $(".xWAddTimeTable").validate({
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>EticketTimeTable/EditTimeTableSTAjax",
                ...
                <div class="xCNBchVMaster">
                    <div class="col-xs-8 col-md-8">
                        <ol id="oliMenuNav" class="breadcrumb">
                            ...
                            <li class="xCNLinkClick" ><?= language('ticket/event/event', 'tEditShowTime') ?></li>
                        </ol>      
                            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                    ...
                    <input type="hidden" value="<?php echo $oView[0]->FNTmhID; ?>" name="ohdFNTmhIDOld" id="ohdFNTmhIDOld">	
                    <div class="form-group">
                    ...
                    <div>
                    <select class="selectpicker form-control" id="ocmFNTmhID" name="ocmFNTmhID" style="width: 100%">
                        <option value=""><?= language('ticket/event/event', 'tSelectShowTime') ?></option>
                        <?php foreach ($oHD AS $oValue): ?>
                        <option value="<?= $oValue->FNTmhID ?>" <?php
                            if ($oValue->FNTmhID == $oView[0]->FNTmhID) 
                            {
                                echo 'selected="selected"';
                            }
                            ?>><?= $oValue->FTTmhName ?></option>
                        <?php endforeach; ?>	       
                    </select>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="xCNLabelFrm"><?= language('ticket/event/event', 'tStartDate') ?></label>
                            ...
                            <input class="form-control" type="text" value="<?= date("d-m-Y", strtotime($oView[0]->FDShwStartDate)); ?>" name="oetFDShwStartDate" id="oetFDShwStartDate">
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label class="xCNLabelFrm"><?= language('ticket/event/event', 'tEndDate') ?></label>
                    <div class="input-group">
                            <input class="form-control" type="text" value="<?= date("d-m-Y", strtotime($oView[0]->FDShwEndDate)); ?>" name="oetFDShwEndDate" id="oetFDShwEndDate">
                            <span class="input-group-btn">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="wrap-input100 bootstrap-timepicker">
                            ...
                            <input class="form-control" type="number" min="0" name="onbFNShwCallB4Start" id="onbFNShwCallB4Start" onkeyup="this.value = FsMinMax(this.value, 0, 300)" value="<?= (int) $oView[0]->FNShwCallB4Start ?>">
                        <span class="focus-input100"></span>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="wrap-input100 bootstrap-timepicker input-group">
                    <label class="xCNLabelFrm"><?= language('ticket/event/event', 'tDuration') ?><?= language('ticket/event/event', 'tMinute') ?></label>							
                        <input class="from-control" type="number" min="0" value="<?= (int) $oView[0]->FNShwDuration ?>" name="onbFNShwDuration" id="onbFNShwDuration">
                        <span class="focus-input100"></span>
                    </div>						
                </div>
            </div>
