<script>
    $(function () {
        $("#ofmAddDayoff").validate({
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>EticketLocDayOffAjax",
                    data: $("#ofmAddDayoff").serialize(),
                    cache: false,
                    success: function (msg) {
                        var nDataId = $('.xWBtnSaveActive').data('id');
                        if (nDataId == '1') {
                            JSxCallPage('<?php echo base_url() ?>EticketLocDayOffEditNew/<?= $nLocID ?>/' + msg);
                        } else if (nDataId == '2') {
                ...
                <div class="xCNBchVMaster">
                    <div class="col-xs-8 col-md-8">
                        <ol id="oliMenuNav" class="breadcrumb">
                            ...
                            <li id="oliBCHTitle" class="xCNLinkClick"><?= language('ticket/dayoff/dayoff', 'tAddDayoff') ?></li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <div class="main-content">
        <div class="panel panel-headline">
            <div style="padding:20px;">
                ...
                <div class="row">
                    <div class="col-md-6 col-xs-6 col-sm-6">
                        <div class="xWNameSlider xWshow"></div>
                    </div>
            ...
            <hr>    
            <form action="" method="post" autocorrect="off" autocapitalize="off" autocomplete="off" id="ofmAddDayoff">
                <div class="main-content">
                        <div class="row">
                            <div class="col-md-8">
                                <h4 style="margin-bottom: 15px;">
                                    <?= language('ticket/dayoff/dayoff', 'tDayoff') ?> / <?= language('ticket/dayoff/dayoff', 'tAddDayoff') ?>
                                </h4>
                            </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="form-group" style="width: 49%; float: left;">
                                    ...
                                    <div class="input-group" data-validate="กรุณาใส่<?= language('ticket/dayoff/dayoff', 'tDayoffFrom') ?>">
                                        <input type="text" class="form-control" id="oetFDLdoDateFrm" name="oetFDLdoDateFrm"  value="">
                                ...
                                <div class="form-group" style="width: 49%; float: left;">
                                    ...
                                    <div class="input-group" data-validate="กรุณาใส่<?= language('ticket/dayoff/dayoff', 'tDayoffTo') ?>">
                                        <input type="text" class="form-control" id="oetFDLdoDateTo" name="oetFDLdoDateTo" value="">
                                        <span class="input-group-btn">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" maxlength="100" name="otaFTLdoRmk"></textarea>
