...
class Pdtprice_controller extends MX_Controller {

    public function __construct(){
        parent::__construct ();
        $this->load->model('product/pdtprice/Pdtprice_model');
    }
    ...
    public function FSvCallPdtPriceList(){
        try{
            ...
            $aDataPriDTUnit = $this->Pdtprice_model->FSaMPDTGetDataPdtPriModalUnit($aDataWhere);
