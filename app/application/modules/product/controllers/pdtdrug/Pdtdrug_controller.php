...
class Pdtdrug_controller extends MX_Controller {

    public function __construct() {
        parent::__construct ();
        $this->load->model('company/branch/Branch_model');
        $this->load->model('product/pdtdrug/Pdtdrug_model');
    }
    ...
    public function FSvCDrugPageAdd($nDrugBrowseType,$tDrugBrowseOption){
        ...
        // CheckIDPdtCode
        $aCheckID  =  $this->Pdtdrug_model->FSaMDrugCheckID($aData);
    ...
    public function FSaCDrugAddEvent(){
        try{
            ...
            $aResult = $this->Pdtdrug_model->FSaMDrugAddUpdateMaster($aDataMaster);
