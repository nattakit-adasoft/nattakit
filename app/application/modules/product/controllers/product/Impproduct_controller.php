...
class Impproduct_controller extends MX_Controller {

    public function __construct(){
        parent::__construct ();
        $this->load->model('product/product/Impproduct_model');
    ...
    public function FSaCPDTGetDataImport(){
		...
		$aGetData 					= $this->Impproduct_model->FSaMUSRGetTempData($aDataSearch);
	...
	public function FSaCPDTImportDelete(){
		...
		$aResDel            = $this->Impproduct_model->FSaMPDTImportDelete($aDataMaster);
	...
	public function FSaCPDTImportMove2Master(){
		...
		$this->db->trans_begin();
        $this->Impproduct_model->FSaMPDTImportMove2Master($aDataMaster);
        $this->Impproduct_model->FSaMPDTImportMove2MasterAndReplaceOrInsert($aDataMaster);
        $this->Impproduct_model->FSaMPDTImportMove2MasterDeleteTemp($aDataMaster);
	...
	public function FSaCPDTImportGetItemAll(){
		$aResult  = $this->Impproduct_model->FSaMPDTGetTempDataAtAll($this->input->post('tTabName'));
