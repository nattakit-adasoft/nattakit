...
class Settingconnection_controller extends MX_Controller {
    public function __construct() {
        parent::__construct ();
        $this->load->model('company/settingconnection/Settingconnection_model');
    ...
    public function FSvCUolConnectionDataList(){
        ...
        $aResList   = $this->Settingconnection_model->FSaMSetConnectLDataList($aData);
    ...
    public function FSvCUolConnectionPageEdit(){
        ...
        // TCNTUrlObject
        $aResult    = $this->Settingconnection_model->FSaMGetConCheckID($aData);
    ...
    public function FSaCUolConnectionAddEvent(){
        try{
            ...
            $nCountSeq   = $this->Settingconnection_model->FSnMCountSeq();
            ...
            //For Check Address
            $aChkAddress  = $this->Settingconnection_model->FSaMBchSetConCheckUrlAddress($aDataUrlObj); 

            //For Check UrlType
            $aChkUrlType  = $this->Settingconnection_model->FSaMBchSetConCheckUrlType($aDataUrlObj);
                    ...
                    if($aChkAddress['rtCode'] == 1){
                        ...
                        switch($nUrlType){
                            case '1':  // Type 1 URL
                                $aStaMaster  = $this->Settingconnection_model->FSaMBchSetConAddUpdateMasterUrl($aDataUrlObj); 
                            break;
                            case '2' : // Type 2 Url + AUthor
                                $aStaMaster  = $this->Settingconnection_model->FSaMBchSetConAddUpdateMasterUrlAuthor($aDataUrlObj,$aDataUrlObjlogin);
                            break;
                            case '3' :  // Type 3 url + MQ
                                $aStaMaster  = $this->Settingconnection_model->FSaMBchSetConAddUpdateMasterUrlMQ($aDataUrlObj,$aDataMQMain,$aDataMQDoc,$aDataMQSale,$aDataMQReport);
                            break;
                            ...
                            case '13' : // Type 8 tBchURLAPI2MQMember
                                $aStaMaster  = $this->Settingconnection_model->FSaMBchSetConAddMasterUrlMQMember($aDataUrlObj,$aDataMQMain); 
                            break;
                        }
                        ...
                        $this->Settingconnection_model->FSxMBchSetConSetLastUpdateOnBranch($aLastUpdate);
                        ...
                        if($this->db->trans_status() === false){
                            ...
                            //update Seq
                            $this->Settingconnection_model->FSaMBchSetConUpdateSeqNumber();
                            
                            // Update Img Parth โดยดึงจาก ImageObj                  
                            $this->Settingconnection_model->FSaMBchSetConAddUpdatePathUrl($aDataUrlObj);
    ...
    public function FSaCUolConnectionEditEvent(){
        ...
        if($toldUrltype !=  $nUrlType){
            ...
            $this->Settingconnection_model->FSaMRemoveDataBecauseChangeType($tOldKeyUrl); 
            $aReturn = array(
                'nStaEvent'    => '800',
                'tStaMessg'    => "Unsucess Add Event"
            );
            ...
            if($tPass  ==  true){
                switch($nUrlType){
                    case '1':  // Type 1 URL
                        $aStaMaster  = $this->Settingconnection_model->FSaMBchSetConAddUpdateMasterUrlUpdate($aDataUrlObj,$tOldKeyUrl); 
                    break;
                    case '2' : //Type 2 Url + AUthor
                        $aStaMaster  = $this->Settingconnection_model->FSaMBchSetConAddUpdateMasterUrlAuthorUpdate($aDataUrlObj,$aDataUrlObjlogin,$tOldKeyUrl);
                    break;
                    case '3' :  // Type 3 url + MQ
                        $aStaMaster  = $this->Settingconnection_model->FSaMBchSetConAddUpdateMasterUrlMQUpdate($aDataUrlObj,$aDataMQMain,$aDataMQDoc,$aDataMQSale,$aDataMQReport,$tOldKeyUrl);
                    break;
                    case '4':  // Type 4 API2PSMaster
                        $aStaMaster  = $this->Settingconnection_model->FSaMBchSetConAddUpdateMasterUrlUpdate($aDataUrlObj,$tOldKeyUrl); 
                    break;
    ...
    public function FSaCUolConnectionDeleteEvent(){
        ...
        $aResDel        = $this->Settingconnection_model->FSnMSettingConLDel($aDataMaster);
        //Update Seqent number
        $this->Settingconnection_model->FSaMBchSetConUpdateSeqNumber();
        $nNumRowRsnLoc  = $this->Settingconnection_model->FSnMSettingConGetAllNumRow();
    ...
    public function FSoCUolConnectionDelMultipleEvent(){
        try{
            ...
            $tResult    = $this->Settingconnection_model->FSaMSetingConnDeleteMultiple($aDataDeleteMuti);
