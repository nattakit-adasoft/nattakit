...
class Shopaddress_controller extends MX_Controller {

    public function __construct() {
        parent::__construct ();
        $this->load->model('company/shop/Shopaddress_model');
    }
    ...
    public function FSvCSHPAddressDataTable(){
        ...
        $aShopDataAddress   = $this->Shopaddress_model->FSaMShopAddressDataList($aDataWhere);
    ...
    public function FSvCSHPAddressCallPageAdd(){
        ...
        $aShopDataVersion   = $this->Shopaddress_model->FSaMShopAddressGetVersion();
        $aDataViewAdd       = [
    ...
    public function FSvCSHPAddressCallPageEdit(){
        ...
        $aShopDataVersion   = $this->Shopaddress_model->FSaMShopAddressGetVersion();
        $aDataAddress       = $this->Shopaddress_model->FSaMShopAddressGetDataID($aDataWhereAddress);
        $aDataViewEdit      = [
    ...
    public function FSoCSHPAddressAddEvent(){
        try{
            ...
            $this->Shopaddress_model->FSxMShopAddressAddData($aShopDataAddress);
            $this->Shopaddress_model->FSxMShopAddressUpdateSeq($aShopDataAddress);
    ...
    public function FSoCSHPAddressEditEvent(){
        try{
            ...
            $this->Shopaddress_model->FSxMShopAddressEditData($aShopDataAddress);
            $this->Shopaddress_model->FSxMShopAddressUpdateSeq($aShopDataAddress);
    ...
    public function FSoCSHPAddressDeleteEvent(){
        try{
            ...
            $this->Shopaddress_model->FSaMShopAddressDelete($aDataWhereDelete);
            $this->Shopaddress_model->FSxMShopAddressUpdateSeq($aDataWhereDelete);
