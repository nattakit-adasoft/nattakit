			...
			<table class="table table-striped">
				<thead>
					<tr>
						...
						<th nowrap class="xCNTextBold" style="width:15%;text-align:left;"><?php echo  language('company/warehouse/warehouse','tWahRefCode')?></th>
                        <?php if($aAlwEventWarehouse['tAutStaFull'] == 1 || $aAlwEventWarehouse['tAutStaDelete'] == 1) : ?>
                ...
                <?php if($aDataList['rtCode'] == 1 ):?>
                    <?php foreach($aDataList['raItems'] AS $key=>$aValue){ ?>
                        ...
                        ?>
                        <tr class="text-center xCNTextDetail2 otrWarehouse" id="otrWarehouse<?php echo $key?>" data-code="<?php echo $aValue['rtWahCode']?>" data-name="<?php echo $aValue['rtWahName']?>">
                            <?php if($aAlwEventWarehouse['tAutStaFull'] == 1 || $aAlwEventWarehouse['tAutStaDelete'] == 1) : ?>
                            ...
                            <?php if($aAlwEventWarehouse['tAutStaFull'] == 1 || $aAlwEventWarehouse['tAutStaDelete'] == 1) : ?>
                                <td nowrap class="text-center <?php echo $tDisableTD;?>">
                                    <img class="xCNIconTable xCNIconDelete <?php echo $tDisableImg;?>" onClick="JSnWarehouseDel('<?php echo $nCurrentPage?>','<?php echo $aValue['rtWahCode']?>','<?php echo $aValue['rtWahName']?>','<?= language('common/main/main','tModalConfirmDeleteItemsYN')?>')">
                                </td>
                            <?php endif; ?>

                            <?php if($aAlwEventWarehouse['tAutStaFull'] == 1 || ($aAlwEventWarehouse['tAutStaEdit'] == 1 || $aAlwEventWarehouse['tAutStaRead'] == 1)) : ?>
                            <td>
								<img class="xCNIconTable xCNIconEdit" onClick="JSvCallPageWarehouseEdit('<?php echo $aValue['rtWahCode']?>')">
							</td>
                            <?php endif; ?>
                        </tr>
                    <?php } ?>
