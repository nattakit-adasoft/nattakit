                    ...
                    <?php if($aStyDataList['rtCode'] == 1 ):?>
                        <?php foreach($aStyDataList['raItems'] AS $nKey => $aValue):?>
                            <tr class="text-left xCNTextDetail2 otrSty" id="otrSty<?=$nKey?>" data-code="<?=$aValue['rtStyCode']?>" data-name="<?=$aValue['rtStyName']?>">
                                ...
                                <td class="text-center">
                                    <!-- เปลี่ยน -->
                                    <img class="xCNIconTable" src="<?php echo  base_url().'/application/modules/common/assets/images/icons/delete.png'?>" onClick="JSoStyDel('<?php echo $aValue['rtStyCode']?>','<?php echo $aValue['rtStyName']?>')">
                                </td>
                                <td class="text-center">
                                    <!-- เปลี่ยน -->
