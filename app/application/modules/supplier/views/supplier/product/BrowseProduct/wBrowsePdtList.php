<div>
    <div class="table-responsive">
        <table class="table table-striped xCNTblBrowse" id="otbPdtList">
            <thead>
                <tr class="xCNCenter">
                    <th><?= language('common/browsepdt','tTblPdtCode')?></th>
                    <th><?= language('common/browsepdt','tTblPdtName')?></th>
                    <th><?= language('common/browsepdt','tTblPdtBarCode')?></th>
                    <th><?= language('common/browsepdt','tTblPdtPun')?></th>
                    <th><?= language('common/browsepdt','tTblPdtBalance')?></th>
                    <th><?= language('common/browsepdt','tTblPdtRetail')?></th>
                </tr>
            </thead>
                <?php $tPdtCodeCurrent = ''; ?>
