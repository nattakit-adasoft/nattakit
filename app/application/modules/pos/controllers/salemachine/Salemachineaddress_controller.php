...
class Salemachineaddress_controller extends MX_Controller {

    public function __construct() {
        parent::__construct ();
        $this->load->model('pos/salemachine/Salemachineaddress_model');
    }
    ...
    public function FSvCPOSAddressDataTable(){
        ...
        $aSalemachineDataAddress   = $this->Salemachineaddress_model->FSaMSalemachineAddressDataList($aDataWhere);
    ...
    public function FSvCPOSAddressCallPageAdd(){
        ...
        $aSalemachineDataVersion    = $this->Salemachineaddress_model->FSaMSalemachineAddressGetVersion();
        $aDataViewAdd           = [
    ...
    public function FSvCPOSAddressCallPageEdit(){
        ...
        $aSalemachineDataVersion    = $this->Salemachineaddress_model->FSaMSalemachineAddressGetVersion();
        $aDataAddress               = $this->Salemachineaddress_model->FSaMSalemachineAddressGetDataID($aDataWhereAddress);
        $aDataViewEdit              = [
    ...
    public function  FSoCPOSAddressAddEvent(){
        try{
            ...
            $this->Salemachineaddress_model->FSxMSalemachineAddressAddData($aSalemachineDataAddress);
            $this->Salemachineaddress_model->FSxMSalemachineAddressUpdateSeq($aSalemachineDataAddress);
    ...
    public function FSoCPOSAddressEditEvent(){
        try{
            ...
            $this->Salemachineaddress_model->FSxMSalemachineAddressEditData($aSalemachineDataAddress);
            $this->Salemachineaddress_model->FSxMSalemachineAddressUpdateSeq($aSalemachineDataAddress);
    ...
    public function FSoCPOSAddressDeleteEvent(){
        try{
            ...
            $this->Salemachineaddress_model->FSaMSalemachineAddressDelete($aDataWhereDelete);
            $this->Salemachineaddress_model->FSxMSalemachineAddressUpdateSeq($aDataWhereDelete);
