...
class Cardlogin_controller extends MX_Controller {

    public function __construct() {
        parent::__construct ();
        $this->load->model('company/branch/Branch_model');
        $this->load->model('payment/card/Card_model');
        $this->load->model('payment/cardlogin/Cardlogin_model');
    ...
    public function FSvCCardLogDataList(){
        ...
        $aResList    = $this->Cardlogin_model->FSaMCRDLDataList($aData);
    ...
    public function FSvCCardlogPageEdit(){
        ...
        $aResult    = $this->Cardlogin_model->FSaMCRDLCheckID($aData);
    ...
    public function FSaCCardlogAddEvent(){
        try{
            ...
            $oCountDup  = $this->Cardlogin_model->FSoMCRDLCheckDuplicate($aDataMaster['FTCrdLogin']);

            if($oCountDup==false){
                $this->db->trans_begin();
                $aStaMaster  = $this->Cardlogin_model->FSaMCRDLAddUpdateMaster($aDataMaster);
    ...
    public function FSaCCardlogDeleteEvent(){
       ...
       $aDataMaster = array(
        ...
        $aResDel     = $this->Cardlogin_model->FSnMCRDLDel($aDataMaster);
        $nNumRowRsnLoc  = $this->Cardlogin_model->FSnMLOCGetAllNumRow();
    ...
    public function FSoCCardlogDelMultipleEvent(){
        try{
            ...
            $tResult    = $this->Cardlogin_model->FSaMCRDLDeleteMultiple($aDataDelete);
