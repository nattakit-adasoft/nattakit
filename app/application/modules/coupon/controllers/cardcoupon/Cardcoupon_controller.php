...
class Cardcoupon_controller extends MX_Controller {

	public function __construct() {
            parent::__construct ();
            $this->load->model('cardcoupon/Cardcoupon_model');
    }
    ...
    public function FSaCCCLAddEvent(){
        ...
        try{
            ...
            $oCountDup  = $this->Cardcoupon_model->FSnMCPNCheckDuplicate($aDataMaster['FTCclCode']);
            ...
            if($nStaDup == 0){
                $this->db->trans_begin();
                $aStaEventMaster  = $this->Cardcoupon_model->FSaMCCLAddUpdateMaster($aDataMaster);
                $aStaEventLang    = $this->Cardcoupon_model->FSaMCCLAddUpdateLang($aDataMaster);
    ...
    public function FSaCCCLDeleteEvent(){
        ...
        $aResDel    = $this->Cardcoupon_model->FSnMCCLDel($aDataMaster);
        $aReturn    = array(
    ...
    public function FSvCCCLEditPage(){
        ...
        $aResult        = $this->Cardcoupon_model->FSaMCCLSearchByID($aData);
    ...
    public function FSxCCCLDataTable(){
        ...
        $aResList   = $this->Cardcoupon_model->FSaMCCLList($aData);
        $aGenTable  = array(
