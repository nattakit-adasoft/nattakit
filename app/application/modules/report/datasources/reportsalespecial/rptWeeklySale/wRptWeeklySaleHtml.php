            ...
            <div class="row">
                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                    <?php if(isset($aCompanyInfo) && !empty($aCompanyInfo)) { ?>
                        ...
                        <div class="text-left xCNRptAddress">
                            <label><?=$aDataTextRef['tRptWeelySaleAddrTaxNo'] . $aCompanyInfo['FTAddTaxNo']?></label>
                        </div>
        ...
        <div class="xCNContentReport">
            <div id="odvRptTableAdvance" class="table-responsive">
                <table class="table">
                    <thead>
                    <tr>
                            <th nowrap class="text-center xCNRptColumnHeader"><?php echo @$aDataTextRef['tRptWeeklySale'];?></th>
                            <th nowrap class="text-right xCNRptColumnHeader"><?php echo @$aDataTextRef['tRptWeeklySaleBill'];?></th>
                            <th nowrap class="text-right xCNRptColumnHeader"><?php echo @$aDataTextRef['tRptWeeklySaleGrandTotal'];?></th>
                            <th nowrap class="text-right xCNRptColumnHeader"><?php echo @$aDataTextRef['tRptWeeklySaleCuponDiscount'];?></th>
                            <th nowrap class="text-right xCNRptColumnHeader"><?php echo @$aDataTextRef['tRptWeeklySaleAmtAFdisc'];?></th>
                            <th nowrap class="text-right xCNRptColumnHeader"><?php echo @$aDataTextRef['tRptWeeklySaleVatable'];?></th>
                            <th nowrap class="text-right xCNRptColumnHeader"><?php echo @$aDataTextRef['tRptWeeklySaleVat'];?></th>
                            <th nowrap class="text-right xCNRptColumnHeader"><?php echo @$aDataTextRef['tRptWeeklySaleallinone'];?></th>
                            <th nowrap class="text-right xCNRptColumnHeader"><?php echo @$aDataTextRef['tRptWeeklySaleElocker'];?></th>
                            <th nowrap class="text-right xCNRptColumnHeader"><?php echo @$aDataTextRef['tRptWeeklySaleDoctor'];?></th>
                            <th nowrap class="text-right xCNRptColumnHeader"><?php echo @$aDataTextRef['tRptCrWeeklySaleTelemedicine'];?></th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <?php if(isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) { ?>  
                            ...
                            <?php foreach ($aDataReport['aRptData'] as $nKey => $aValue) { ?>
                                ...
                                <tr>
                                    <td nowrap class="text-center xCNRptDetail"><?php echo $aValue['FNSaleWeekly']; ?></td>
                                ...
                                <?php
                                    ...
                                    $paFooterSumData = array(
                                        $aDataTextRef['tRptWeelySaleFooter'],
                            ...
                            ?>
                        <?php }else { ?>
                            <tr><td class='text-center xCNRptDetail' colspan='100%'><?php echo $aDataTextRef['tRptWeeklySaleNoData'];?></td></tr>
                        <?php } ;?>
                    </tbody>
                </table>
            </div>
