        ...
        <div class="xCNContentReport">
            <div id="odvRptTableAdvance" class="table-responsive">
                <table class="table">
                    <thead>
                        <tr>
                            <th nowrap class="text-center xCNRptColumnHeader"   style="vertical-align : middle;text-align:center; width:5%;"><?=$aDataTextRef['tRptDate']; ?></th>
                            <th nowrap class="text-left xCNRptColumnHeader"   style="vertical-align : middle;text-align:right; width:10%;"><?=$aDataTextRef['tRptRentBillAmount']; ?></th>
                            <th nowrap class="text-left xCNRptColumnHeader"   style="vertical-align : middle;text-align:right; width:10%;"><?=$aDataTextRef['tRptPriceGrand']; ?></th>
                            ...
                            <th nowrap class="text-left xCNRptColumnHeader"   style="vertical-align : middle;text-align:left; width:20%;"><?=$aDataTextRef['tRptReason']; ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) { ?>
                            ...
                            <?php foreach ($aDataReport['aRptData'] as $nKey => $aValue) { ?>
                                <tr>
                                    <td class="text-center xCNRptDetail"><?=date("d/m/Y", strtotime($aValue['FDXshDocDate']));?></td>
                                    <td class="text-right xCNRptDetail"><?=$aValue["FNXshTotalBill"]?></td>
                                    ...
                                    <td class="text-left xCNRptDetail"><?=($aValue["FTXshRem"] == '' ) ? '-' : $aValue["FTXshRem"];?></td>
                                </tr>    
                            <?php } ?>
                            ...
                            <?php
                                ...
                                if ($nPageNo == $nTotalPage) { ?>
                                    <tr class='xCNRptSumFooterTr'>
                                        ...
                                        <td class="text-right " style="font-weight: bold !important;"></td>
                                    </tr>
                                <?php }
                            ?>
