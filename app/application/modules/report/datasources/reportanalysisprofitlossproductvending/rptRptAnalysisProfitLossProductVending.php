...
class rptRptAnalysisProfitLossProductVending extends \koolreport\KoolReport {
    ...
    protected function setup(){
        $this->src('DataReport')->pipe($this->dataStore('rptRptAnalysisProfitLossProductVending'));
    }
