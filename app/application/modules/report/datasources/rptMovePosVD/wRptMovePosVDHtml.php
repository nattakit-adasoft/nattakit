                        ...
                        <?php if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) : ?>
                            ...
                            <?php foreach ($aDataReport['aRptData'] as $nKey => $aValue) : ?>
                                ...
                                if ($aValue['FNRowPartIDBch'] == $aValue['FNRptGroupMember_SUBBCH'] || $aValue['FNRowPartIDWah'] == $aValue['FNRptGroupMember_SUBWAH']) {
                                    ...
                                    $nStkQtyMonEnd_FWAH = number_format($aValue['FCStkQtyMonEnd_SUBWAH'], $nOptDecimalShow);
                                    $nStkQtyIn_FWAH = number_format($aValue['FCStkQtyIn_SUBWAH'], $nOptDecimalShow);
                                    $nStkQtyOut_FWAH = number_format($aValue['FCStkQtyOut_SUBWAH'], $nOptDecimalShow);
                                    $nStkQtySale_FWAH = number_format($aValue['FCStkQtySale_SUBWAH'], $nOptDecimalShow);
                                    $nStkQtyAdj_FWAH = number_format($aValue['FCStkQtyAdj_SUBWAH'], $nOptDecimalShow);
                                    $nStkQtyBal_FWAH = number_format($aValue['FCStkQtyBal_SUBWAH'], $nOptDecimalShow);
                                ...
                                if ($aValue['FNRowPartIDBch'] == $aValue['FNRptGroupMember_SUBBCH']) {
                                    ...
                                    $nStkQtyMonEnd_FBch = number_format($aValue['FCStkQtyMonEnd_SUBBCH'], $nOptDecimalShow);
                                    $nStkQtyIn_FBch = number_format($aValue['FCStkQtyIn_SUBBCH'], $nOptDecimalShow);
                                    $nStkQtyOut_FBch = number_format($aValue['FCStkQtyOut_SUBBCH'], $nOptDecimalShow);
                                    $nStkQtySale_FBch = number_format($aValue['FCStkQtySale_SUBBCH'], $nOptDecimalShow);
                                    $nStkQtyAdj_FBch = number_format($aValue['FCStkQtyAdj_SUBBCH'], $nOptDecimalShow);
                                    $nStkQtyBal_FBch = number_format($aValue['FCStkQtyBal_SUBBCH'], $nOptDecimalShow);
