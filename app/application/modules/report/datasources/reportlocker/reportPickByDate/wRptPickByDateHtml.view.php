        ...
        <div class="xCNContentReport">
            <div id="odvTableKoolReport" class="table-responsive">
                <?php if (isset($aDataReport['rtCode']) && !empty($aDataReport['rtCode']) && $aDataReport['rtCode'] == '1') {?>
                    <?php
                    Table::create(array(
                        "dataSource" => $this->dataStore("RptPickByDate"),
                        "cssClass" => array(
                            "table" => "table",
                        ),
                        "headers" => array(
                            array(
                                $aDataTextRef['tRptLockerPickByDatePickDate'] => array(
                        ...
                        "columns" => array(
                            ...
                            'FTXsdTimeFinish' => array(
                                "label" => $aDataTextRef['tRptLockerPickByDatePickTime'],
                                "cssStyle" => array(
                                    // "th" => "display:none"
                                ),
                                "formatValue" => function ($value, $row) {
                ...
                <?php } else {?>
                    <table class="table">
                        <thead>
                            <th nowrap class="text-center" style="width:10%"><?php echo $aDataTextRef['tRptLockerPickByDatePickDate']; ?></th>
