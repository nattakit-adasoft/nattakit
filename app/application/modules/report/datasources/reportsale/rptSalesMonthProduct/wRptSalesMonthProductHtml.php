            ...
            <table class="table" >
                    <thead>
                        ...
                        <tr >
                            ...
                            <th  class="text-center xCNRptColumnHeader" ><?php echo $aDataTextRef['tRptSMPCode']; ?></th>
                        ...
                        <?php 
                            ...
                            if ($nPageNo == $nTotalPage) { ?>
                                <tr class="xCNRptSumFooterTr">
                                    <td colspan="14" class="text-left xCNRptSumFooter"><?php echo $aDataTextRef['tRptTotalFooter']; ?></td>
