...
<div id="odvRptTaxSalePosHtml">
    <div class="container-fluid xCNLayOutRptHtml">
        ...
        <div class="xCNContentReport">
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th nowrap class="text-left xCNRptColumnHeader" style="vertical-align : middle;text-align:left; width:10%;">ช่องทางการขาย</th>
                        ...
                        <?php if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) { ?>
                            ...
                            <?php foreach ($aDataReport['aRptData'] as $nKey => $aValue) { ?>
                                ...
                                if ($tGrouppingBch != $tBchCode && $nCountBch > 0) {
                                    $aSumFooter = array('N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N');
                                    if ($nRowPartID == $nGroupMember) {
                                        echo '<tr>';
                                ...
                                if ($tGrouppingBch != $tBchCode) {
                                    FCNtHRPTHeadGrouppingRptTSPBch($nRowPartID, $aGrouppingDataBch, 8);
                                ...
                                if ($nPosCodeOld != $aValue["FTPosCode"]) {
                                    echo "<tr><td class='xCNRptGrouPing' colspan='13' style='border-bottom: dashed 1px #333 !important;'></td></tr>";
                                    echo "<tr>";
                                    for ($i = 0; $i < count($aGrouppingData); $i++) {
                                        //echo '<td>'.$nPosXshAmt.'</td>';
                                        if ($aGrouppingData[$i] == $aGrouppingData[0]) {
                                            echo "<td class='xCNRptGrouPing' colspan='8' style='padding: 5px; text-indent:22px;'>" . $aGrouppingData[$i] . "</td>";
                                        } else {
                                ...
                                <tr>
                                    ...
                                    <td class="text-left xCNRptDetail">
                                        <?php
                                        echo !empty($aValue["FTChnName"]) ? $aValue["FTChnName"] : '-';
                                        ?>
                                    </td>
            ...
            <?php if ((isset($aDataFilter['tChannelFrom']) && !empty($aDataFilter['tChannelFrom'])) && (isset($aDataFilter['tChannelTo']) && !empty($aDataFilter['tChannelTo']))) : ?>
                <div class="xCNRptFilterBox">
                    <div class="text-left xCNRptFilter">
