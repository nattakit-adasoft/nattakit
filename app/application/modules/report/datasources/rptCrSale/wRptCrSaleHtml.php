    ...
    <div class="container-fluid xCNLayOutRptHtml">
        ...
        <div class="xCNContentReport">
            ...
            <table class="table" width="100%">
                    <thead>
                        <tr>
                            <th  class="text-left xCNRptColumnHeader" style="width:7%;vertical-align: middle;  "><?php echo $aDataTextRef['tRptCrPos']; ?></th>
                            <th  class="text-left xCNRptColumnHeader" style="width:7%;vertical-align: middle; "><?php echo $aDataTextRef['tRptCrTaxNumber']; ?></th>
                            <th  class="text-center xCNRptColumnHeader" style="width:7%;vertical-align: middle; "><?php echo $aDataTextRef['tRptCrSaleDate']; ?></th>
                            <th  class="text-left xCNRptColumnHeader" style="width:7%;vertical-align: middle; "><?php echo $aDataTextRef['tRptCrPaymentType']; ?></th>
                            <th  class="text-left xCNRptColumnHeader" style="width:7%;vertical-align: middle; "><?php echo $aDataTextRef['tRptCrProduct']; ?></th>
                            <th  class="text-right xCNRptColumnHeader"style="width:7%;vertical-align: middle;"><?php echo $aDataTextRef['tRptCrNet']; ?></th>
                            <th  class="text-right xCNRptColumnHeader"style="width:7%;vertical-align: middle;"><?php echo $aDataTextRef['tRptCrPrice']; ?></th>
                            <th  class="text-right xCNRptColumnHeader"style="width:7%;vertical-align: middle;"><?php echo $aDataTextRef['tRptCrVat']; ?></th>
                            <th  class="text-right xCNRptColumnHeader"style="width:7%;vertical-align: middle;"><?php echo $aDataTextRef['tRptCrTotal']; ?></th>
                            <th  class="text-left xCNRptColumnHeader"style="width:7%;vertical-align: middle;"><?php echo $aDataTextRef['tRptCrDescription']; ?></th>
                            <th  class="text-left xCNRptColumnHeader"style="width:7%;vertical-align: middle;"><?php echo $aDataTextRef['tRptCrHnNumber']; ?></th>
                            <th  class="text-left xCNRptColumnHeader"style="width:7%;vertical-align: middle;"><?php echo $aDataTextRef['tRptCrCtzID']; ?></th>
                            <th  class="text-left xCNRptColumnHeader"style="width:7%;vertical-align: middle;"><?php echo $aDataTextRef['tRptCrCstName'].' '.$aDataTextRef['tRptCrCstlName']; ?></th>
                    
                            <th  class="text-left xCNRptColumnHeader"style="width:7%;vertical-align: middle;"><?php echo $aDataTextRef['tRptCrCstTel']; ?></th>
                            <th  class="text-left xCNRptColumnHeader"style="width:7%;vertical-align: middle;"><?php echo $aDataTextRef['tRptCrCstDescription']; ?></th>
                        </tr>
                    </thead>
                    <tbody>
                    <?php
                     if(!empty($aDataReport['aRptData'])){
                         foreach($aDataReport['aRptData'] as $aData){
                            ...
                            $cXrcVatable_Footer=$aData['FCXshVatable_Footer'];
                            $cXrcVat_Footer=$aData['FCXshVat_Footer'];
                            $cXrcGrand_Footer=$aData['FCXshGrand_Footer'];
                           $tPdtName=explode(',',$aData['FTPdtName']);
                           $tXrcRmk1=explode(',',$aData['FTXrcRmk1']);
                           $tXrcRmk2=explode(',',$aData['FTXrcRmk2']);
                        
                    ?>
                        <tr>
                            <td  class="text-left xCNRptDetail" style="width:7%;  "><?php echo $aData['FTPosCode']; ?></td>
                            <td  class="text-left xCNRptDetail" style="width:7%;"><?php echo$aData['FTXshDocNo']; ?></td>
                            <td  class="text-center xCNRptDetail" style="width:7%; "><?php echo date('d/m/Y',strtotime($aData['FDXshDocDate'])); ?></td>
                            <td  class="text-left xCNRptDetail" style="width:7%; "><?php echo $aData['FTRcvName']; ?></td>
                            <td  class="text-left xCNRptDetail" style="width:7%; "><?php 
                                    if(!empty($tPdtName)){
                                        foreach($tPdtName as $aData2){
                                                    echo $aData2.'<br>';
                                        }
                                    }
                            ?></td>
                            <td  class="text-right xCNRptDetail"style="width:7%;"><?php echo number_format($aData['FCXrcNet'],2); ?></td>
                            <td  class="text-right xCNRptDetail"style="width:7%;"><?php echo number_format($aData['FCXsdVatable'],2); ?></td>
                            <td  class="text-right xCNRptDetail"style="width:7%;"><?php echo number_format($aData['FCXsdVat'],2); ?></td>
                            <td  class="text-right xCNRptDetail"style="width:7%;"><?php echo number_format($aData['FCXrcGrand'],2); ?></td>
                            <td  class="text-left xCNRptDetail "style="width:7%;"><?php echo $aData['FTXrcRmk1'];
                            //  if(!empty($tXrcRmk1)){
                            //     foreach($tXrcRmk1 as $aData2){
                            //                 echo $aData2.'<br>';
                            //     }
                            // }
                            ?></td>
                            <td  class="text-left xCNRptDetail"style="width:7%;"></td>
                            <td  class="text-left xCNRptDetail"style="width:7%;"><?php echo $aData['FTCstCode']; ?></td>
                            <td  class="text-left xCNRptDetail"style="width:7%;"><?php echo $aData['FTXshCstName']; ?></td>
                            <td  class="text-left xCNRptDetail"style="width:7%;"><?php echo $aData['FTXshCstTel']; ?></td>
                            <td  class="text-left xCNRptDetail"style="width:7%;"><?php echo $aData['FTXrcRmk2'];
                            // if(!empty($tXrcRmk2)){
                            //     foreach($tXrcRmk2 as $aData2){
                            //                 echo $aData2.'<br>';
                            //     }
                            // }
                            ?></td>
