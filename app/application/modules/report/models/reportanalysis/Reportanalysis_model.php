...
class Reportanalysis_model extends CI_Model {
    ...
    public function FSaMRPAGetAddTaxNo($ptBchCode){
        try{
            ...
            echo 'Error Reportanalysis_model Function(FSaMRPTCRDGetAddTaxNo) =>'.$Error;
        }
    }
    ...
    public function FSaMRptAnsRptSaleShopByDate($paFilterReport, $pnStaOverLimit){
        try{
            ...
            echo 'Error Reportanalysis_model Function(FSaMRptAnsRptSaleShopByDate) =>'.$Error;
        }
    }
    ...
    public function FSaMRptAnsRptSaleShopByDateCount($paFilterReport){
        try{
            ...
            echo 'Error Reportanalysis_model Function(FSaMRptAnsRptSaleShopByDateCount) =>'.$Error;
        }
    }
    ...
    public function FSaMRptSaleShopByShop($paFilterReport, $pnStaOverLimit){
        try{
            ...
            echo 'Error Reportanalysis_model Function(FSaMRptSaleShopByShop) =>'.$Error;
        }
    }
    ...
    public function FSaMRptCardActiveSummary($paFilterReport,$pnStaOverLimit){
        try{
            ...
            echo 'Error Reportanalysis_model Function(FSaMRptCardActiveSummary) =>'.$Error;
        }
    }
    ...
    public function FSaMRptCardActiveDetail($paFilterReport,$pnStaOverLimit){
        try{
            ...
            echo 'Error Reportanalysis_model Function(FSaMRptCardActiveDetail) =>'.$Error;
        }
    }
    ...
    public function FSaMRptCardActiveDetailCount($paFilterReport){
        try{
           ...
           echo 'Error Reportanalysis_model Function(FSaMRptCardActiveDetailCount) =>'.$Error;
       }
    }
    ...
    public function FSaMRptUnExchangeBalanceCount($paFilterReport){
        try{
            ...
            echo 'Error Reportanalysis_model Function(FSaMRptUnExchangeBalanceCount) =>'.$Error;
        }
    }
