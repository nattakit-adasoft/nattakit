...
date_default_timezone_set("Asia/Bangkok");
class Rptdayendsales_controller extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportsale/Rptdayendsales_model');
    ...
    public function index()
    {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->Rptdayendsales_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paData)
    {
        ...
        // Get Data Report
        $aDataReport = $this->Rptdayendsales_model->FSaMGetDataReport($aDataWhere);
    ...
    public function FSoCChkDataReportInTableTemp($paDataSwitchCase)
    {
        try {
            ...
            $nDataCountPage = $this->Rptdayendsales_model->FSnMCountDataReportAll($aDataCountData);
    ...
    public function FSvCCallRptRenderExcel()
    {
        ...
        $tFileName = 'Rpt-'.$this->aText['tRptEndDaySaleTitle'] . '_' . date('YmdHis') . '.xlsx';
        ...
        // Get Data Report
        $aDataReport = $this->Rptdayendsales_model->FSaMGetDataReport($aDataReportParams);
