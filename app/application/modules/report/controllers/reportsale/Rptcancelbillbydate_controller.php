...
date_default_timezone_set("Asia/Bangkok");
class Rptcancelbillbydate_controller extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportsale/Rptcancelbillbydate_model');
    ...
    public function index()
    {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->Rptcancelbillbydate_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint()
    {
        ...
        $aDataReport = $this->Rptcancelbillbydate_model->FSaMGetDataReport($aDataWhereRpt);
    ...
    public function FSoCChkDataReportInTableTemp()
    {
        try {
            ...
            $nDataCountPage = $this->Rptcancelbillbydate_model->FSnMCountRowInTemp($aDataCountData);
            $aResponse = array(
