...
date_default_timezone_set("Asia/Bangkok");
class Rpttaxsalepos_controller extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportsale/Rpttaxsalepos_model');
    ...
    public function index()
    {
        ...
        if (!empty($this->tRptCode) && !empty($this->tRptExportType)) {
            ...
            $this->Rpttaxsalepos_model->FSnMExecStoreReport($this->aRptFilter);
            // Count Rows
            $aCountRowParams = [
            ...
            $this->nRows = $this->Rpttaxsalepos_model->FSnMCountRowInTemp($aCountRowParams);
    ...
    public function FSvCCallRptViewBeforePrint()
    {
        try {
            ...
            $aDataReport = $this->Rpttaxsalepos_model->FSaMGetDataReport($aDataReportParams);
            /** =========== End Get Data ===================================== */
            /** =========== Begin Render View ================================ */
    ...
    public function FSvCCallRptRenderExcel()
    {
        ...
        $aDataReport = $this->Rpttaxsalepos_model->FSaMGetDataReport($aGetDataReportParams);
        /** =========== End Get Data ========================================= */
        try {
    ...
    public function FSoCChkDataReportInTableTemp()
    {
        try {
            ...
            $nDataCountPage = $this->Rpttaxsalepos_model->FSnMCountRowInTemp($aDataCountData);
