...
date_default_timezone_set("Asia/Bangkok");
class Rptreturnproductbydate_controller extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportsale/Rptreturnproductbydate_model');
    ...
    public function index()
    {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->Rptreturnproductbydate_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint()
    {
        ...
        $aDataReport = $this->Rptreturnproductbydate_model->FSaMGetDataReport($aDataWhereRpt);
    ...
    public function FSoCChkDataReportInTableTemp()
    {
        try {
            ...
            $nDataCountPage = $this->Rptreturnproductbydate_model->FSnMCountRowInTemp($aDataCountData);
            $aResponse = array(
    ...
    public function FSvCCallRptRenderExcel()
    {
        ...
        $aDataReport = $this->Rptreturnproductbydate_model->FSaMGetDataReport($aDataReportParams);
