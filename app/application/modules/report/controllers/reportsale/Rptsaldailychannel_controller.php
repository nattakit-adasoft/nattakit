...
date_default_timezone_set("Asia/Bangkok");
class Rptsaldailychannel_controller extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportsale/Rptsaldailychannel_model');
    ...
    private function init()
    {
        $this->aText = [
            //Title
            'tTitleReport' => language('report/report/report', 'tRptSalDailySOKADETitle'),
            ...
            'tRptRefDoc' => language('report/report/report', 'tRptRefDoc'),
            'tRptTaxSalePosTaxId' => language('report/report/report', 'tRptTaxSalePosTaxId'),
            'tRptBillNote' => language('report/report/report', 'tRptBillNote'),
            ...
            'tRptRnd' => language('report/report/report', 'tRptRnd'),
            ...
            'tRptSOKADSNumber' => language('report/report/report', 'tRptSOKADSNumber'),
        ...
        $this->aRptFilter = [
            ...
            // ช่องทางการขาย
            'tChannelFrom'      => !empty($this->input->post('oetRptChannelCodeFrom')) ? $this->input->post('oetRptChannelCodeFrom') : "",
            'tChannelTo'        => !empty($this->input->post('oetRptChannelCodeTo')) ? $this->input->post('oetRptChannelCodeTo') : "",
    ...
    public function index()
    {
        if (!empty($this->tRptCode) && !empty($this->tRptExportType)) {
            ...
            $this->Rptsaldailychannel_model->FSnMExecStoreReport($this->aRptFilter);
            // Count Rows
            $aCountRowParams = [
            ...
            $this->nRows = $this->Rptsaldailychannel_model->FSnMCountRowInTemp($aCountRowParams);
    ...
    public function FSvCCallRptViewBeforePrint()
    {
        try {
            ...
            $aDataReport = $this->Rptsaldailychannel_model->FSaMGetDataReport($aDataReportParams);
            /** =========== End Get Data ===================================== */
            /** =========== Begin Render View ================================ */
            ...
            $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/reportsale/rptsaldailychannel', 'wRptSalDailyChannelHtml', $aDataViewRptParams);
    ...
    public function FSoCChkDataReportInTableTemp()
    {
        try {
            ...
            $nDataCountPage = $this->Rptsaldailychannel_model->FSnMCountRowInTemp($aDataCountData);
    ...
    public function FSvCCallRptExportFile()
    {
        ...
        $aCells = [
            ...
            WriterEntityFactory::createCell(language('report/report/report', 'tRptRefDoc')),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptSOKADSNumber')),
            WriterEntityFactory::createCell('ช่องทางการขาย'),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptCustCode')),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptBillNote')),
            ...
            WriterEntityFactory::createCell(language('report/report/report', 'tRptDisChgNotVat')),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptRnd')),
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                ...
                $cFCXshVatable = FCNnGetNumeric(empty($aValue['FCXshVatable']) ? 0 : $aValue['FCXshVatable']);
                ...
                $cFCXshRnd = FCNnGetNumeric(empty($aValue['FCXshRnd']) ? 0 : $aValue['FCXshRnd']);
                $cFCXshGrand = FCNnGetNumeric(empty($aValue['FCXshGrand']) ? 0 : $aValue['FCXshGrand']);

                $cFCXshVatable_Footer = empty($aValue['FCXshVatable_Footer']) ? 0 : $aValue['FCXshVatable_Footer'];
                ...
                $cFCXshRnd_Footer = empty($aValue['FCXshRnd_Footer']) ? 0 : $aValue['FCXshRnd_Footer'];
                $cFCXshGrand_Footer = empty($aValue['FCXshGrand_Footer']) ? 0 : $aValue['FCXshGrand_Footer'];
                ...
                $values = [
                    ...
                    WriterEntityFactory::createCell(($aValue['FTXshSOKADS'] == "" ? "-" : $aValue['FTXshSOKADS'])),
                    WriterEntityFactory::createCell(($aValue['FTChnName'] == "" ? "-" : $aValue['FTChnName'])),
                    WriterEntityFactory::createCell(($aValue['FTCstCode'] == "" ? "-" : $aValue['FTCstCode'])),
                    WriterEntityFactory::createCell(($aValue['FTXshRmk'] == "" ? "-" : $aValue['FTXshRmk'])),
                    WriterEntityFactory::createCell($cFCXshVatable),
                    WriterEntityFactory::createCell($cFCXshVat),
                    WriterEntityFactory::createCell($cFCXshAmtNV),
                    WriterEntityFactory::createCell($cFCXshRnd),
                    WriterEntityFactory::createCell($cFCXshGrand)
                ];
                ...
                if (($nKey + 1) == count($aDataReport['aRptData'])) { //SumFooter
                    $values = [
                        ...
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(FCNnGetNumeric($cFCXshVatable_Footer)),
                        ...
                        WriterEntityFactory::createCell(FCNnGetNumeric($cFCXshRnd_Footer)),
                        WriterEntityFactory::createCell(FCNnGetNumeric($cFCXshGrand_Footer))
                    ];
    ...
    public function FSoCCallRptRenderFooterExcel()
    {
        ...
        // ช่องทางการขาย
        if (!empty($this->aRptFilter['tChannelFrom']) && !empty($this->aRptFilter['tChannelTo'])) {
            $aCells = [
                WriterEntityFactory::createCell('จากช่องทางการขาย' . ' ' . $this->aRptFilter['tChannelFrom'] . '     ' . 'ถึงช่องทางการขาย' . ' ' . $this->aRptFilter['tChannelTo']),
                WriterEntityFactory::createCell(null),
                WriterEntityFactory::createCell(null),
                WriterEntityFactory::createCell(null),
                WriterEntityFactory::createCell(null),
