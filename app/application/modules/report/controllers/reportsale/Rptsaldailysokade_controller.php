...
class Rptsaldailysokade_controller extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportsale/Rptsaldailysokade_model');
    ...
    public function index()
    {
        if (!empty($this->tRptCode) && !empty($this->tRptExportType)) {
            ...
            $this->Rptsaldailysokade_model->FSnMExecStoreReport($this->aRptFilter);
            // Count Rows
            $aCountRowParams = [
            ...
            $this->nRows = $this->Rptsaldailysokade_model->FSnMCountRowInTemp($aCountRowParams);
    ...
    public function FSvCCallRptViewBeforePrint()
    {
        try {
            ...
            $aDataReport = $this->Rptsaldailysokade_model->FSaMGetDataReport($aDataReportParams);
            /** =========== End Get Data ===================================== */
            /** =========== Begin Render View ================================ */
            ...
            $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/reportsale/RptSalDailySOKADE', 'wRptSalDailySOKADEHtml', $aDataViewRptParams);
    ...
    public function FSoCChkDataReportInTableTemp()
    {
        try {
            ...
            $nDataCountPage = $this->Rptsaldailysokade_model->FSnMCountRowInTemp($aDataCountData);
