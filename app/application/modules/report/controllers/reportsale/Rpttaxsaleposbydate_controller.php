...
date_default_timezone_set("Asia/Bangkok");
class Rpttaxsaleposbydate_controller extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportsale/Rpttaxsaleposbydate_model');
    ...
    public function index()
    {
        ...
        if (!empty($this->tRptCode) && !empty($this->tRptExportType)) {
            ...
            $this->Rpttaxsaleposbydate_model->FSnMExecStoreReport($this->aRptFilter);
            ...
            $this->nRows = $this->Rpttaxsaleposbydate_model->FSnMCountRowInTemp($aCountRowParams);
    ...
    public function FSvCCallRptViewBeforePrint()
    {
        try {
            ...
            $aDataReport = $this->Rpttaxsaleposbydate_model->FSaMGetDataReport($aDataReportParams);
            /** =========== End Get Data ===================================== */
            /** =========== Begin Render View ================================ */
    ...
    //         'aRptFilter' => $this->aRptFilter,
    //     );
    //     $aDataReport = $this->Rpttaxsaleposbydate_model->FSaMGetDataReport($aGetDataReportParams);
    //     /** =========== End Get Data ========================================= */
    //     try {
    ...
    public function FSoCChkDataReportInTableTemp()
    {
        try {
            ...
            $nDataCountPage = $this->Rpttaxsaleposbydate_model->FSnMCountRowInTemp($aCountRowInTempParams);
