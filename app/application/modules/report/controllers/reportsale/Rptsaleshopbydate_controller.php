...
class Rptsaleshopbydate_controller extends MX_Controller {
    ...
    public function __construct(){
        ...
        $this->load->model('report/reportsale/Rptsaleshopbydate_model');
    }
    ...
    public function index(){
        ...
        if(!empty($tRptTypeExport) && !empty($tRptCode)){
            ...
            $this->Rptsaleshopbydate_model->FSnMExecStoreReport($aDataFilter);
    ...
    public function FSvCCallRptViewBeforePrint($ptRptRoute,$ptRptCode,$ptRptTypeExport,$paDataFilter){
        ...
        // Get Data Report
        $aDataReport    = $this->Rptsaleshopbydate_model->FSaMGetDataReport($aDataWhere);
