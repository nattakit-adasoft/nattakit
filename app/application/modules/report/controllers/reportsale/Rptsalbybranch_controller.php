...
class Rptsalbybranch_controller extends MX_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('report/reportsale/Rptsalbybranch_model');
    ...
    public function index() {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->Rptsalbybranch_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    */
    public function FSvCCallRptViewBeforePrint() {
        ...
        $aDataReport = $this->Rptsalbybranch_model->FSaMGetDataReport($aDataWhereRpt);
    ...
    */
    public function FSoCChkDataReportInTableTemp() {
        try {
            ...
            $nDataCountPage = $this->Rptsalbybranch_model->FSnMCountRowInTemp($aDataCountData);
            $aResponse = array(
  ...
  //Get Data
  $aDataReport = $this->Rptsalbybranch_model->FSaMGetDataReport($aDataReportParams);
