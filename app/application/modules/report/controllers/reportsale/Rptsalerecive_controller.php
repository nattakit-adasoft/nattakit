...
date_default_timezone_set("Asia/Bangkok");
class Rptsalerecive_controller extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportsale/Rptsalerecive_model');
    ...
    public function index()
    {
        ...
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->Rptsalerecive_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase)
    {
        ...
        $aDataReport2 = $this->Rptsalerecive_model->FMxMRPTGetDataStat($this->aRptFilter);

        // print_r($aDataReport2);
        // exit;
        $aDataReport = $this->Rptsalerecive_model->FSaMGetDataReport($aDataWhereRpt);
        // echo '<pre>';
    ...
    public function FSoCChkDataReportInTableTemp($paDataSwitchCase)
    {
        try {
            ...
            $nDataCountPage = $this->Rptsalerecive_model->FSnMCountDataReportAll($aDataCountData);
    ...
    public function FSvCCallRptRenderExcel($paDataSwitchCase)
    {
        ...
        $aDataReport = $this->Rptsalerecive_model->FSaMGetDataReport($aGetDataReportParams);
