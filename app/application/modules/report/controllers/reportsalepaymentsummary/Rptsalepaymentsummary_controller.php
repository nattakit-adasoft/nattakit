...
class Rptsalepaymentsummary_controller extends MX_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('report/reportsalepaymentsummary/Rptsalepaymentsummary_model');
    ...
    public function index() {
        if (!empty($this->tRptCode) && !empty($this->tRptExportType)) {
            ...
            $this->Rptsalepaymentsummary_model->FSnMExecStoreCReport($this->aRptFilter);
            // Count Rows
            ...
            $this->nRows = $this->Rptsalepaymentsummary_model->FSaMCountDataReportAll($aCountRowParams);
    ...
    public function FSvCCallRptViewBeforePrint() {
        ...
        $aDataReport = $this->Rptsalepaymentsummary_model->FSaMGetDataReport($aDataReportParams);
        /** ====================================================================================== */
        /** ================================== Begin Render View ================================= */
    ...
    public function FSoCChkDataReportInTableTemp() {   
        ...
        $nDataCountPage = $this->Rptsalepaymentsummary_model->FSaMCountDataReportAll($aCountRowParams);
        $aResponse = array(
