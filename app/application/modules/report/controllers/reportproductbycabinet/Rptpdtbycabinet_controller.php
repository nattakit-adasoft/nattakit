...
class Rptpdtbycabinet_controller extends MX_Controller {
     /**
     * ภาษา
     * @var array
     */
    ...
    public function __construct() {
        ...
        $this->load->model('report/reportproductbycabinet/Rptpdtbycabinet_model');
    ...
    private function init() {
        $this->aText = [
            'tTitleReport'              => language('report/report/report', 'tRptCBNTitleProductByCabinet'),
            ...
            'tRptChannel'                => language('report/report/report', 'tRptChannel'),
            ...
            'tRptCBNCabinetName'        => language('report/report/report', 'tRptCBNCabinetName'),
        ...
        public function index() {
            ...
            if (!empty($this->tRptCode) && !empty($this->tRptExportType)) {
                ...
                $this->Rptpdtbycabinet_model->FSnMExecStoreCReport($this->aRptFilter);
                // Count Rows
                $aCountRowParams = [
                ...
                $this->nRows = $this->Rptpdtbycabinet_model->FSnMCountDataReportAll($aCountRowParams);
    ...
    public function FSvCCallRptViewBeforePrint() {
        try {
            ...
            $aDataReport = $this->Rptpdtbycabinet_model->FSaMGetDataReport($aDataReportParams);
            /** =========== End Get Data ===================================== */
            /** =========== Begin Render View ================================ */
            ...
            $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/rptPdtByCabinet', 'wRptPdtByCabinetHtml', $aDataViewRptParams);
    ...
    public function FSoCChkDataReportInTableTemp() {
        try {
            ...
            $nDataCountPage = $this->Rptpdtbycabinet_model->FSnMCountRowInTemp($aDataCountData);
