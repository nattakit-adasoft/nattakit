...
class cRptSaleSoNotPass extends MX_Controller {
 /**
     * ภาษา
     * @var array
     */
    ...
    public function __construct() {
        ...
        $this->load->model('report/reportsalesonotpass/mRptSaleSoNotPass');
    ...
    private function init(){
        ...
        public function index(){
            ...
            if (!empty($this->tRptCode) && !empty($this->tRptExportType)) {
                ...
                $this->mRptSaleSoNotPass->FSnMExecStoreCReport($this->aRptFilter);
                ...
                $this->nRows = $this->mRptSaleSoNotPass->FSnMCountDataReportAll($aCountRowParams);
    ...
    public function FSvCCallRptViewBeforePrint(){
        try{
            ...
            $aDataReport = $this->mRptSaleSoNotPass->FSaMGetDataReport($aDataReportParams);
    ...
    public function FSoCChkDataReportInTableTemp(){
        try{
            ...
            $nDataCountPage = $this->mRptSaleSoNotPass->FSnMCountRowInTemp($aDataCountData);
