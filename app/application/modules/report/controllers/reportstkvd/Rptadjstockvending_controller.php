...
class Rptadjstockvending_controller extends MX_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('report/reportstkvd/Rptadjstockvending_model');
    ...
    public function index() {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->Rptadjstockvending_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase) {
        try{
            ...
            $aDataReport = $this->Rptadjstockvending_model->FSaMGetDataReport($aDataWhere);
    ...
    public function FSvCCallRptViewBeforePrintClickPage() {
        ...
        $aDataReport = $this->Rptadjstockvending_model->FSaMGetDataReport($aDataWhereRpt);
    ...
    public function FSoCChkDataReportInTableTemp($paDataSwitchCase) {
        try {
            ...
            $nDataCountPage = $this->Rptadjstockvending_model->FSnMCountDataReportAll($aDataCountData);
