...
class Rptdropbydate_controller extends MX_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('report/reportlocker/Rptdropbydate_model');
    ...
    public function index() {
        ...
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->Rptdropbydate_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase) {
        ...
        // Get Data Report
        $aDataReport = $this->Rptdropbydate_model->FSaMGetDataReport($aDataWhere, $this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrintClickPage() {
        ...
        $aDataReport = $this->Rptdropbydate_model->FSaMGetDataReport($aDataWhere, $aDataFilter);
    ...
    public function FSvCCallRptRenderExcel($paDataSwitchCase) {
        try {
            ...
            $aDataReport = $this->Rptdropbydate_model->FSaMGetDataReport($aDataWhere); //Get Data
    ...
    public function FSoCChkDataReportInTableTemp($paDataSwitchCase) {
        ...
        try {
            ...
            $nDataCountPage = $this->Rptdropbydate_model->FSaMCountDataReportAll($aDataCountData);
