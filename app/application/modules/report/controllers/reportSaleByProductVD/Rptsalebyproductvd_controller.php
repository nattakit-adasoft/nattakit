...
class Rptsalebyproductvd_controller extends MX_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('report/rptsalebyproductvd/Rptsalebyproductvd_model');
    ...
    public function index() {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $aRetrun = $this->Rptsalebyproductvd_model->FSnMExecStoreReport($this->aRptFilter);
            // print_r($aRetrun );
            // exit;
    ...
    public function FSoCChkDataReportInTableTemp($paDataSwitchCase){
        try{
            ...
            $nDataCountPage = $this->Rptsalebyproductvd_model->FSnMCountRowInTemp($aDataCountData);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase) {
        ...
        // exit;
        $aDataReport = $this->Rptsalebyproductvd_model->FSaMGetDataReport($aDataWhereRpt);
    ...
    public function FSvCCallRptRenderExcel($paDataSwitchCase) {
        try{
           ...
           $aDataReportParams = [
            ...
            $aDataReport = $this->Rptsalebyproductvd_model->FSaMGetDataReport($aDataReportParams);
