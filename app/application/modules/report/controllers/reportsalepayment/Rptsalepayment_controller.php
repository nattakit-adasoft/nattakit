...
class Rptsalepayment_controller extends MX_Controller {
    ...
    public function __construct(){
        ...
        $this->load->model('report/reportsalepayment/Rptsalepayment_model');
    }
    ...
    public function index(){
        ...
        if(!empty($tRptTypeExport) && !empty($tRptCode)){
            ...
            $result = $this->Rptsalepaymentsummary_model->FSnMExecStoreCReport($aDataFilter);
    ...
    public function FSvCCallRptViewBeforePrint($ptRptRoute,$ptRptCode,$ptRptTypeExport,$paDataFilter){
        ...
        // Get Data Report
        $aDataReport    = $this->Rptsalepaymentsummary_model->FSaMGetDataReport($aDataWhere,$aDataFilter); //Get Data
    ...
    public function FCNvCRenderKoolReportHtml($paDataReport,$paDataFilter){
        ...
        $aDataAddress    = $this->Rptsalepaymentsummary_model->FSaMCMPAddress($aDataRef);//Get Data ที่อยู่
