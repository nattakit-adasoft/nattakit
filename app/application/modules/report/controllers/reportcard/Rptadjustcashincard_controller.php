...
class Rptadjustcashincard_controller extends MX_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('report/reportcard/Rptadjustcashincard_model');
    ...
    public function index() {
        ...
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->Rptadjustcashincard_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase) {
        ...
        // Get Data Report
        $aDataReport = $this->Rptadjustcashincard_model->FSaMGetDataReport($aDataWhere, $this->aRptFilter);

        if ($aDataReport['rnCurrentPage'] == $aDataReport['rnAllPage']) {
            $aDataSumFooterReport = $this->Rptadjustcashincard_model->FSaMRPTCRDGetDataRptAdjustCashInCardSum($aDataWhere);
    ...
    public function FSvCCallRptViewBeforePrintClickPage() {
        ...
        $aDataReport = $this->Rptadjustcashincard_model->FSaMGetDataReport($aDataWhere, $aDataFilter);
    ...
    public function FSoCChkDataReportInTableTemp($paDataSwitchCase) {
        ...
        try {
            ...
            $nDataCountPage = $this->Rptadjustcashincard_model->FSaMCountDataReportAll($aDataCountData);
