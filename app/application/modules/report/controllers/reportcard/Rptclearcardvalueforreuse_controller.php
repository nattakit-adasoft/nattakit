...
class Rptclearcardvalueforreuse_controller extends MX_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('report/reportcard/Rptclearcardvalueforreuse_model');
    ...
    public function index() {
        ...
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->Rptclearcardvalueforreuse_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase) {
        ...
        // Get Data Report
        $aDataReport = $this->Rptclearcardvalueforreuse_model->FSaMGetDataReport($aDataWhere, $this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrintClickPage() {
        ...
        $aDataReport = $this->Rptclearcardvalueforreuse_model->FSaMGetDataReport($aDataWhere, $aDataFilter);
    ...
    public function FSoCChkDataReportInTableTemp($paDataSwitchCase) {
        ...
        try {
            ...
            $nDataCountPage = $this->Rptclearcardvalueforreuse_model->FSaMCountDataReportAll($aDataCountData);
