...
class Rptcardnoactive_controller extends MX_Controller {
    ...
    * Sys Bch Code
    ...
    public function __construct() {
        ...
        $this->load->model('report/reportcard/Rptcardnoactive_model');
    ...
    public function index() {
        ...
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->Rptcardnoactive_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase = []) {
        ...
        // Get Data Report
        $aDataReport = $this->Rptcardnoactive_model->FSaMGetDataReport($aDataWhere, $this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrintClickPage() {
        ...
        $aDataReport = $this->Rptcardnoactive_model->FSaMGetDataReport($aDataWhere, $aDataFilter);
    ...
    public function FSoCChkDataReportInTableTemp($paDataSwitchCase = []) {
        ...
        try {
            ...
            $nDataCountPage = $this->Rptcardnoactive_model->FSaMCountDataReportAll($aDataCountData);
