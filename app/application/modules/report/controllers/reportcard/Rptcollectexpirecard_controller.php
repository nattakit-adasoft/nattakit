...
class Rptcollectexpirecard_controller extends MX_Controller {
    /**
     * ภาษา
     * @var array
     */
    ...
    public function __construct() {
        ...
        $this->load->model('report/reportcard/Rptcollectexpirecard_model');
    ...
    public function index() {
        ...
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->Rptcollectexpirecard_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase) {
        ...
        // Get Data Report
        $aDataReport = $this->Rptcollectexpirecard_model->FSaMGetDataReport($aDataWhere, $this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrintClickPage() {
        ...
        $aDataReport = $this->Rptcollectexpirecard_model->FSaMGetDataReport($aDataWhere, $aDataFilter);
    ...
    public function FCNvCRenderKoolReportHtml($paDataReport, $paDataFilter) {
        ...
        if(@$aDataReport['rnCurrentPage'] == @$aDataReport['rnAllPage']){
            ...
            @$aSumDataReport = $this->Rptcollectexpirecard_model->FSaMRPTCRDGetDataRptCollectExpireCardSum($aDataWhere);
        }
    ...
    public function FSoCChkDataReportInTableTemp($paDataSwitchCase) {
        ...
        try {
            ...
            $nDataCountPage = $this->Rptcollectexpirecard_model->FSaMCountDataReportAll($aDataCountData);
