...
class cRptProductSaleOfWeek extends MX_Controller {
    ...
    public function __construct(){
        ...
        $this->load->model('report/reportProductSaleOfWeek/mRptProductSaleOfWeek');
        // Init Report
        $this->init();
        parent::__construct();
    }
    ...
    public function index()
    {
        ...
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->mRptProductSaleOfWeek->FSnMExecStoreCReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase)
    {
        ...
        $aDataReport = $this->mRptProductSaleOfWeek->FSaMGetDataReport($aDataWhere, $this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrintClickPage()
    {
        ...
        // Get Data ReportFSaMGetDataReport
        $aDataReport = $this->mRptProductSaleOfWeek->FSaMGetDataReport($aDataWhere, $aDataFilter);
    ...
    public function FSoCChkDataReportInTableTemp($paDataSwitchCase)
    {
        try {
            ...
            $nDataCountPage = $this->mRptProductSaleOfWeek->FSnMCountDataReportAll($aDataCountData);
