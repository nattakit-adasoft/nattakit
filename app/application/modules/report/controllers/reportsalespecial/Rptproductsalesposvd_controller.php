...
class Rptproductsalesposvd_controller extends MX_Controller {
    ...
    */
    ...
    public function __construct() {
        ...
        $this->load->model('report/reportsalespecial/Rptproductsalesposvd_model');
        $this->init();
        parent::__construct();
    }
    ...
    public function index() {
        if(!empty($this->tRptCode) && !empty($this->tRptExportType)){
            $this->Rptproductsalesposvd_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    */
    public function FSvCCallRptViewBeforePrint() {
        ...
        $aDataReport = $this->Rptproductsalesposvd_model->FSaMGetDataReport($aDataWhereRpt);
    ...
    public function FSoCChkDataReportInTableTemp(){
        try {
            ...
            $nDataCountPage = $this->Rptproductsalesposvd_model->FSnMCountRowInTemp($aDataCountData);
            $aResponse = array(
