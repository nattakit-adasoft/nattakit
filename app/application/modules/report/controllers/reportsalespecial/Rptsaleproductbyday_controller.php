...
class Rptsaleproductbyday_controller extends MX_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('report/reportsalespecial/Rptsaleproductbyday_model');
    ...
    private function init() {
        $this->aText = [
            'tTitleReport'          => language('report/report/report', 'tRptSaleProductByDay'),
    ...
    public function index() {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->Rptsaleproductbyday_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase) {
        ...
        $aDataReport = $this->Rptsaleproductbyday_model->FSaMGetDataReport($aDataWhereRpt);
        ...
        $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/reportsalespecial/rptsaleproductbyday', 'wRptSaleProductByDayHtml', $aDataViewPdt);
    ...
    public function FSoCChkDataReportInTableTemp($paDataSwitchCase) {
        try {
            ...
            $nDataCountPage = $this->Rptsaleproductbyday_model->FSnMCountDataReportAll($aDataCountData);
            $aResponse = array(
