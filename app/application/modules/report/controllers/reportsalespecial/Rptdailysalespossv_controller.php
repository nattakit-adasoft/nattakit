...
class Rptdailysalespossv_controller extends MX_Controller {
       /**
     * ภาษา
     * @var array
     */
    ...
    public function __construct() {
        ...
        $this->load->model('report/reportsalespecial/Rptdailysalespossv_model');
    ...
    public function index() {
        if (!empty($this->tRptCode) && !empty($this->tRptExportType)) {
            ...
            $this->Rptdailysalespossv_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint(){
        try{
            ...
            //Get Data
            $aDataReport = $this->Rptdailysalespossv_model->FSaMGetDataReport($aDataReportParams);

            //Get Data Sum
            $aDataSumFoot = $this->Rptdailysalespossv_model->FSaMGetDataSumFootReport($aDataReportParams);
    ...
    public function FSvCCallRptViewBeforePrintClickPage(){
        ...
        //Get Data
        $aDataReport = $this->Rptdailysalespossv_model->FSaMGetDataReport($aDataWhere, $aDataFilter);

        //Get Data Sum
        $aDataSumFoot = $this->Rptdailysalespossv_model->FSaMGetDataSumFootReport($aDataWhere, $aDataFilter);
    ...
    public function FSoCChkDataReportInTableTemp(){
        try{
            ...
            $nDataCountPage = $this->Rptdailysalespossv_model->FSnMCountRowInTemp($aDataCountData);
