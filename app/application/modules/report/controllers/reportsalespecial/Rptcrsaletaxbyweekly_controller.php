...
class Rptcrsaletaxbyweekly_controller extends MX_Controller {
     /**
     * ภาษา
     * @var array
     */
    ...
    public function __construct() {
        ...
        $this->load->model('report/reportsalespecial/Rptcrsaletaxbyweekly_model');
        $this->init();
        parent::__construct();
    }
    ...
    public function index() {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            // $this->Rptcrsaletaxbyweekly_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    */
    public function FSvCCallRptViewBeforePrint(){
        ...
        $aDataReport = $this->Rptcrsaletaxbyweekly_model->FSaMGetDataReport($aDataWhereRpt);
