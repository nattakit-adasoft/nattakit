...
class cRptCrSale extends MX_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('report/reportsalespecial/mRptCrSale');
    ...
    public function index() {
        ...
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->mRptCrSale->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase) {
        ...
        $aDataReport = $this->mRptCrSale->FSaMGetDataReport($aDataWhereRpt);
        // echo '<pre>';
    ...
    public function FSoCChkDataReportInTableTemp($paDataSwitchCase) {
        ...
        try {
            ...
            $nDataCountPage = $this->mRptCrSale->FSnMCountDataReportAll($aDataCountData);
