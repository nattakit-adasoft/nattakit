...
class Rptdailysalestax_controller extends MX_Controller {
    ...
    */
    ...
    public function __construct() {
        ...
        $this->load->model('report/reportsalespecial/Rptdailysalestax_model');
        $this->init();
        parent::__construct();
    }
    ...
    private function init(){
        $this->aText    = [
            'tTitleReport'          => language('report/report/report','tRptSaleTaxByDaily'),
    ...
    public function index() {
        if(!empty($this->tRptCode) && !empty($this->tRptExportType)){
            $this->Rptdailysalestax_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    */
    public function FSvCCallRptViewBeforePrint() {
        ...
        $aDataReport = $this->Rptdailysalestax_model->FSaMGetDataReport($aDataWhereRpt);
        ...
        $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/reportsalespecial/rptdailysalestax', 'wRptDailySalesTaxHtml', $aDataViewRpt);
    ...
    public function FSoCChkDataReportInTableTemp(){
        try {
            ...
            $nDataCountPage = $this->Rptdailysalestax_model->FSnMCountRowInTemp($aDataCountData);
            $aResponse = array(
