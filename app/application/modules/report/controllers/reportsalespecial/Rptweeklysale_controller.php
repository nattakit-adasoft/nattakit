...
class Rptweeklysale_controller extends MX_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('report/reportsalespecial/Rptweeklysale_model');
    ...
    public function index() {
        if (!empty($this->tRptCode) && !empty($this->tRptExportType)) {
            ...
            $this->Rptweeklysale_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint(){
        try{
            ...
            //Get Data
            $aDataReport = $this->Rptweeklysale_model->FSaMGetDataReport($aDataReportParams);

            //Get Data Sum
            $aDataSumFoot = $this->Rptweeklysale_model->FSaMGetDataSumFootReport($aDataReportParams);
    ...
    */
    public function FSoCChkDataReportInTableTemp() {
        try {
            ...
            $nDataCountPage = $this->Rptweeklysale_model->FSnMCountRowInTemp($aDataCountData);
            $aResponse = array(
