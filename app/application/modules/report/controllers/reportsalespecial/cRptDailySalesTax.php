...
class cRptDailySalesTax extends MX_Controller {
    ...
    */
    ...
    public function __construct() {
        ...
        $this->load->model('report/reportsalespecial/mRptDailySalesTax');
        $this->init();
        parent::__construct();
    }
    ...
    public function index() {
        if(!empty($this->tRptCode) && !empty($this->tRptExportType)){
            $this->mRptDailySalesTax->FSnMExecStoreReport($this->aRptFilter);
    ...
    */
    public function FSvCCallRptViewBeforePrint() {
        ...
        $aDataReport = $this->mRptDailySalesTax->FSaMGetDataReport($aDataWhereRpt);
    ...
    public function FSoCChkDataReportInTableTemp(){
        try {
            ...
            $nDataCountPage = $this->mRptDailySalesTax->FSnMCountRowInTemp($aDataCountData);
            $aResponse = array(
