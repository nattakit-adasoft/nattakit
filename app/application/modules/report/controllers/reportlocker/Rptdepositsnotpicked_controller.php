...
class Rptdepositsnotpicked_controller extends MX_Controller {
    ...
    */
    ...
    public function __construct() {
        ...
        $this->load->model('report/reportlocker/Rptdepositsnotpicked_model');
        // Init Report
        $this->init();
        parent::__construct();
    }
    ...
    public function index() {
        if (!empty($this->tRptCode) && !empty($this->tRptExportType)) {
            ...
            $this->Rptdepositsnotpicked_model->FSnMExecStoreCReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataMain) {
        try {
            ...
            /*=====  Get Data ==========================================================*/
            $aDataReport        = $this->Rptdepositsnotpicked_model->FSaMGetDataReport($aDataReportParams);
            /*===== End Get Data =======================================================*/
    ...
    public function FSoCChkDataReportInTableTemp($paDataMain) {
        ...
        try {
            ...
            $nDataCountPage = $this->Rptdepositsnotpicked_model->FSnMCountRowInTemp($aDataCountData);
