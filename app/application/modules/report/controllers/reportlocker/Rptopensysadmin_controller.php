...
class Rptopensysadmin_controller extends MX_Controller {
    ...
    */
    ...
    public function __construct(){
        ...
        $this->load->model('report/reportlocker/Rptopensysadmin_model');
        $this->init();
        parent::__construct();
    }
    ...
    private function init(){
        $this->aText    = [
            ...
            'tRptOpenSysAdminShpCode'   => language('report/report/report', 'tRptOpenSysAdminShpCode'),
            'tRptOpenSysAdminShpName'   => language('report/report/report', 'tRptOpenSysAdminShpName'),
            'tRptOpenSysAdminPosCode'   => language('report/report/report', 'tRptOpenSysAdminPosCode'),
            'tRptOpenSysAdminPosName'   => language('report/report/report', 'tRptOpenSysAdminPosName'),
            'tRptOpenSysAdminDateOpen'  => language('report/report/report', 'tRptOpenSysAdminDateOpen'),
            'tRptOpenSysAdminTimeOpen'  => language('report/report/report', 'tRptOpenSysAdminTimeOpen'),
            'tRptOpenSysAdminLayNo'     => language('report/report/report', 'tRptOpenSysAdminLayNo'),
            'tRptOpenSysAdminRsnCode'   => language('report/report/report', 'tRptOpenSysAdminRsnCode'),
            'tRptOpenSysAdminRsnName'   => language('report/report/report', 'tRptOpenSysAdminRsnName'),
            'tRptOpenSysAdminUserCode'  => language('report/report/report', 'tRptOpenSysAdminUserCode'),
            'tRptOpenSysAdminUserName'  => language('report/report/report', 'tRptOpenSysAdminUserName'),
    ...
    public function index() {
        if(!empty($this->tRptCode) && !empty($this->tRptExportType)){
            ...
            $this->Rptopensysadmin_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    // Creator: 03/12/2019 Wasin(Mr.JW)
    // LastUpdate: -
    ...
    public function FSvCCallRptViewBeforePrint() {
        ...
        $aDataReport    = $this->Rptopensysadmin_model->FSaMGetDataReport($aDataReportParams);
        ...
        $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/rptRptOpenSysAdmin','wRptOpenSysAdminHtml',$aDataViewRptParams);
    ...
    // Parameters:  Function Parameter
    // Creator: 06/12/2019 Wasin(Mr.JW)
    // LastUpdate: -
    // Return: View Report Viewer
    // ReturnType: View
    public function FSvCCallRptViewBeforePrintClickPage(){
        ...
        $aDataReport    = $this->Rptopensysadmin_model->FSaMGetDataReport($aDataWhereRpt);
    ...
    public function FSoCChkDataReportInTableTemp(){
        ...
        $nDataCountPage = $this->Rptopensysadmin_model->FSnMCountDataReportAll($aDataCountData);
        $aResponse      = [
