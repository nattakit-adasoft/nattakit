...
class cRptPickByDate extends MX_Controller {
    ...
    public function index() {
        ...
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->mRptPickByDate->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase) {
        ...
        // Get Data Report
        $aDataReport = $this->mRptPickByDate->FSaMGetDataReport($aDataWhere, $this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrintClickPage() {
        ...
        $aDataReport = $this->mRptPickByDate->FSaMGetDataReport($aDataWhere, $aDataFilter);
    ...
    public function FSvCCallRptRenderExcel($paDataSwitchCase) {
        try {
            ...
            $aDataReport = $this->mRptPickByDate->FSaMGetDataReport($aDataWhere);
            /** ===== End Get Data ==================================================== */
    ...
    public function FSoCChkDataReportInTableTemp($paDataSwitchCase) {
        ...
        try {
            ...
            $nDataCountPage = $this->mRptPickByDate->FSaMCountDataReportAll($aDataCountData);
