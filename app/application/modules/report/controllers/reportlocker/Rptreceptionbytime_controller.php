...
class Rptreceptionbytime_controller extends MX_Controller {
    ...
    */
    ...
    public function __construct() {
        ...
        $this->load->model('report/reportlocker/Rptreceptionbytime_model');
    ...
    public function index() {
        if (!empty($this->tRptCode) && !empty($this->tRptExportType)) {
            ...
            $this->Rptreceptionbytime_model->FSnMExecStoreCReport($this->aRptFilter);
            $aDataMain = array(
    ...
    public function FSvCCallRptViewBeforePrint($paDataMain) {
        try {
            ...
            /*=====  Get Data ==========================================================*/
            $aDataReport        = $this->Rptreceptionbytime_model->FSaMGetDataReport($aDataReportParams);
            /*===== End Get Data =======================================================*/
            /*===== Begin Render View ==================================================*/
    ...
    public function FSoCChkDataReportInTableTemp($paDataMain) {
        ...
        try {
            ...
            $nDataCountPage = $this->Rptreceptionbytime_model->FSnMCountRowInTemp($aDataCountData);
