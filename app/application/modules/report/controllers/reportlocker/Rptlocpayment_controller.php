...
class Rptlocpayment_controller extends MX_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('report/reportlocker/Rptlocpayment_model');
    ...
    public function index() {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $Result = $this->Rptlocpayment_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase) {
        ...
        // Get Data Report
        $aDataReport = $this->Rptlocpayment_model->FSaMGetDataReport($aDataWhere, $this->aRptFilter); //Get Data
    ...
    public function FSvCCallRptViewBeforePrintClickPage() {
        ...
        // Get Data Report  
        $aDataReport = $this->Rptlocpayment_model->FSaMGetDataReport($aDataWhere, $aDataFilter);
    ...
    public function FSoCChkDataReportInTableTemp($paData) {
        ...
        try {
            ...
            $nDataCountPage = $this->Rptlocpayment_model->FSaMCountDataReportAll($aDataCountData);
