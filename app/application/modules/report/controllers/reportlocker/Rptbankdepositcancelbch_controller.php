...
class Rptbankdepositcancelbch_controller extends MX_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('report/reportlocker/Rptbankdepositcancelbch_model');
    ...
    public function index() {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->Rptbankdepositcancelbch_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    */
    public function FSvCCallRptViewBeforePrint() {
        ...
        $aDataReport = $this->Rptbankdepositcancelbch_model->FSaMGetDataReport($aDataWhereRpt);
    ...
    */
    public function FSoCChkDataReportInTableTemp() {
        try {
            ...
            $nDataCountPage = $this->Rptbankdepositcancelbch_model->FSnMCountRowInTemp($aDataCountData);
            $aResponse = array(
  ...
  //Get Data
  $aDataReport = $this->Rptbankdepositcancelbch_model->FSaMGetDataReport($aDataReportParams);
