...
class cRptPaymentByBill extends MX_Controller {
    ...
    public function __construct(){
        ...
        $this->load->model('report/reportlocker/mRptPaymentByBill');
        // Init Report
        $this->init();
        parent::__construct();
    }
    ...
    public function index()
    {
        ...
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->mRptPaymentByBill->FSnMExecStoreCReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase)
    {
        ...
        $aDataReport = $this->mRptPaymentByBill->FSaMGetDataReport($aDataWhere, $this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrintClickPage()
    {
        ...
        // Get Data ReportFSaMGetDataReport
        $aDataReport = $this->mRptPaymentByBill->FSaMGetDataReport($aDataWhere, $aDataFilter);
    ...
    public function FSoCChkDataReportInTableTemp($paDataSwitchCase)
    {
        try {
            ...
            $nDataCountPage = $this->mRptPaymentByBill->FSnMCountDataReportAll($aDataCountData);
