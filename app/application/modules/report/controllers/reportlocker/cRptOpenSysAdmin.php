...
class cRptOpenSysAdmin extends MX_Controller {
    ...
    */
    ...
    public function FSvCCallRptViewBeforePrint() {
        ...
        $aDataReport    = $this->mRptOpenSysAdmin->FSaMGetDataReport($aDataReportParams);
    ...
    public function FSvCCallRptViewBeforePrintClickPage(){
        ...
        $aDataReport    = $this->mRptOpenSysAdmin->FSaMGetDataReport($aDataWhereRpt);
    ...
    public function FSoCChkDataReportInTableTemp(){
        ...
        $nDataCountPage = $this->mRptOpenSysAdmin->FSnMCountDataReportAll($aDataCountData);
        $aResponse      = [
