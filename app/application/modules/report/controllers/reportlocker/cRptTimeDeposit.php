...
class cRptTimeDeposit extends MX_Controller{
    ...
    */
    ...
    public function __construct(){
        ...
        $this->load->model('report/reportlocker/mRptTimeDeposit');
    ...
    public function index(){
        if (!empty($this->tRptCode) && !empty($this->tRptExportType)) {
            ...
            $this->mRptTimeDeposit->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataMain) {
        try{
            ...
            // Get data 
            $aDataReport   = $this->mRptTimeDeposit->FSaMGetDataReport($aDataReportParams);
    ...
    public function FSoCChkDataReportInTableTemp($paDataMain){
        try{
            ...
            $nDataCountPage = $this->mRptTimeDeposit->FSnMCountRowInTemp($aDataCountData);
