...
class cRptLockerPayment extends MX_Controller {
    ...
    */
    ...
    public function __construct() {
        ...
        $this->load->model('report/reportlocker/mRptLockerPayment');
        $this->init();
        parent::__construct();
    }
    ...
    public function index() {
        if(!empty($this->tRptCode) && !empty($this->tRptExportType)){
            $this->mRptLockerPayment->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint(){
        ...
        $aDataReport    = $this->mRptLockerPayment->FSaMGetDataReport($aDataReportParams);
    ...
    public function FSoCChkDataReportInTableTemp(){
        ...
        $nDataCountPage = $this->mRptLockerPayment->FSnMCountDataReportAll($aDataCountData);
        $aResponse = array(
