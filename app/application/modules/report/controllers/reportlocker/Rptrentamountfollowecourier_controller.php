...
class Rptrentamountfollowecourier_controller extends MX_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('report/reportlocker/Rptrentamountfollowecourier_model');
    ...
    public function index() {
        ...
        if (!empty($this->tRptCode) && !empty($this->tRptExportType)) {
            ...
            $this->Rptrentamountfollowecourier_model->FSnMExecStoreReport($this->aRptFilter);
            ...
            $this->nRows = $this->Rptrentamountfollowecourier_model->FSaMCountDataReportAll($aCountRowParams);
    ...
    public function FSvCCallRptViewBeforePrint() {
        try {
            ...
            $aDataReport = $this->Rptrentamountfollowecourier_model->FSaMGetDataReport($aDataReportParams);
            /*===== End Get Data =======================================================*/
    ...
    public function FSoCChkDataReportInTableTemp() {
        try {
            ...
            $nDataCountPage = $this->Rptrentamountfollowecourier_model->FSaMCountDataReportAll($aDataCountData);
