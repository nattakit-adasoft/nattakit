...
date_default_timezone_set("Asia/Bangkok");
class Rptbankdepositbch_controller extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportlocker/Rptbankdepositbch_model');
    ...
    public function index()
    {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->Rptbankdepositbch_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint()
    {
        ...
        $aDataReport = $this->Rptbankdepositbch_model->FSaMGetDataReport($aDataWhereRpt);
    ...
    public function FSoCChkDataReportInTableTemp()
    {
        try {
            ...
            $nDataCountPage = $this->Rptbankdepositbch_model->FSnMCountRowInTemp($aDataCountData);
            $aResponse = array(
