...
class Rptdetailreceivedeposit_controller extends MX_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('report/reportlocker/Rptdetailreceivedeposit_model');
    ...
    public function index() {
        if (!empty($this->tRptCode) && !empty($this->tRptExportType)) {
           ...
           $this->Rptdetailreceivedeposit_model->FSnMExecStoreCReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataMain) {
        try {
            ...
            /*=====  Get Data ==========================================================*/
            $aDataReport        = $this->Rptdetailreceivedeposit_model->FSaMGetDataReport($aDataReportParams);
            /*===== End Get Data =======================================================*/
            /*===== Begin Render View ==================================================*/
    ...
    public function FSoCChkDataReportInTableTemp($paDataMain) {
        ...
        try {
            ...
            $nDataCountPage = $this->Rptdetailreceivedeposit_model->FSnMCountRowInTemp($aDataCountData);
