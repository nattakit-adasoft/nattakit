...
class Rptdetaildepositamount_controller extends MX_Controller {
    ...
    */
    ...
    public function __construct(){
        ...
        $this->load->model('report/reportlocker/Rptdetaildepositamount_model');
        // Init Report
        $this->init();
        parent::__construct();
    }
    ...
    public function index()
    {
        ...
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->Rptdetaildepositamount_model->FSnMExecStoreCReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase)
    {
        ...
        $aDataReport = $this->Rptdetaildepositamount_model->FSaMGetDataReport($aDataWhere, $this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrintClickPage()
    {
        ...
        // Get Data ReportFSaMGetDataReport
        $aDataReport = $this->Rptdetaildepositamount_model->FSaMGetDataReport($aDataWhere, $aDataFilter);
    ...
    public function FSoCChkDataReportInTableTemp($paDataSwitchCase)
    {
        try {
            ...
            $nDataCountPage = $this->Rptdetaildepositamount_model->FSnMCountDataReportAll($aDataCountData);
