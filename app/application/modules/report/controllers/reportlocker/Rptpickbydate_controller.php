...
class Rptpickbydate_controller extends MX_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('report/reportlocker/Rptpickbydate_model');
    ...
    private function init() {
        $this->aText = [
            'tTitleReport' => language('report/report/report', 'tRptLockerPickByDateTitle'),
            ...
            // Table Report
            'tRptLockerPickByDatePickDate' => language('report/report/report', 'tRptLockerPickByDatePickDate'),
            ...
            'tRptLockerPickByDatePickTime' => language('report/report/report', 'tRptLockerPickByDatePickTime'),
    ...
    public function index() {
        ...
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->Rptpickbydate_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase) {
        ...
        // Get Data Report
        $aDataReport = $this->Rptpickbydate_model->FSaMGetDataReport($aDataWhere, $this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrintClickPage() {
        ...
        $aDataReport = $this->Rptpickbydate_model->FSaMGetDataReport($aDataWhere, $aDataFilter);
    ...
    public function FCNvCRenderKoolReportHtml($paDataReport, $paDataFilter) {
        ...
        require_once APPPATH . 'modules\report\datasources\reportlocker\reportPickByDate\rRptPickByDate.php';

        // Set Parameter To Report
        $oRptPickByDateHtml = new rRptPickByDate(array(
        ...
        $oRptPickByDateHtml->run();
        $tHtmlViewReport = $oRptPickByDateHtml->render('wRptPickByDateHtml', true);
    ...
    public function FSvCCallRptRenderExcel($paDataSwitchCase) {
        try {
            ...
            $aDataTextRef = array(
                'tTitleReport' => language('report/report/report', 'tRptTitleRptPickByDate'),
                'tRptTaxNo' => language('report/report/report', 'tRptTaxNo'),
                'tRptDatePrint' => language('report/report/report', 'tRptDatePrint'),
                'tRptDateExport' => language('report/report/report', 'tRptDateExport'),
                'tRptTimePrint' => language('report/report/report', 'tRptTimePrint'),
                ...
                'tRptPickByDate' => language('common/main/main', 'tCMNNotFoundData'),
                // Address Lang
            ...
            $aDataReport = $this->Rptpickbydate_model->FSaMGetDataReport($aDataWhere);
            /** ===== End Get Data ==================================================== */
            ...
            if ($aDataReport['rtCode'] == 1) {
                ...
                $objPHPExcel->setActiveSheetIndex(0)->setCellValue('A' . $nStartRowData, $aDataTextRef['tRptPickByDate']);
    ...
    public function FSoCChkDataReportInTableTemp($paDataSwitchCase) {
        ...
        try {
            ...
            $nDataCountPage = $this->Rptpickbydate_model->FSaMCountDataReportAll($aDataCountData);
