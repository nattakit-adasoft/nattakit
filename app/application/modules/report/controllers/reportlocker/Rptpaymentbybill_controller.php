...
class Rptpaymentbybill_controller extends MX_Controller {
    ...
    public function __construct(){
        ...
        $this->load->model('report/reportlocker/Rptpaymentbybill_model');
        // Init Report
        $this->init();
        parent::__construct();
    }
    ...
    private function init(){
        $this->aText = [
            'tTitleReport' => language('report/report/report', 'tRptLockerPaymentByBillTitle'),
            ...
            'tRptPaymentToTal' => language('report/report/report', 'tRptPaymentToTal'),
            'tRptOutstandingBalance' => language('report/report/report', 'tRptOutstandingBalance'),
            'tRptPaymentDocNo' => language('report/report/report', 'tRptPaymentDocNo'),
    ...
    public function index()
    {
        ...
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->Rptpaymentbybill_model->FSnMExecStoreCReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase)
    {
        ...
        $aDataReport = $this->Rptpaymentbybill_model->FSaMGetDataReport($aDataWhere, $this->aRptFilter);
    ...
    public function FCNvCRenderKoolReportHtml($paDataReport, $paDataFilter)
    {
        ...
        require_once APPPATH . 'modules\report\datasources\reportlocker\rptPaymentByBill\rRptPaymentByBill.php';

        // Set Parameter To Report
        $oRptPaymentByBill = new rRptPaymentByBill(array(
            'aCompanyInfo' => $this->aCompanyInfo,
        ...
        $oRptPaymentByBill->run();
        $tHtmlViewReport = $oRptPaymentByBill->render('wRptPaymentByBillHtml', true);
    ...
    public function FSvCCallRptViewBeforePrintClickPage()
    {
        ...
        // Get Data ReportFSaMGetDataReport
        $aDataReport = $this->Rptpaymentbybill_model->FSaMGetDataReport($aDataWhere, $aDataFilter);
    ...
    public function FSoCChkDataReportInTableTemp($paDataSwitchCase)
    {
        try {
            ...
            $nDataCountPage = $this->Rptpaymentbybill_model->FSnMCountDataReportAll($aDataCountData);
