...
class Rptinventory_controller extends MX_Controller {
    /**
     * ภาษา
     * @var array
     */
    ...
    public function __construct() {
        ...
        $this->load->model('report/reportinventory/Rptinventory_model');
    ...
    private function init() {
        ...
        public function index() {
            ...
            if (!empty($this->tRptCode) && !empty($this->tRptExportType)) {
                ...
                $this->Rptinventory_model->FSnMExecStoreCReport($this->aRptFilter);
                // Count Rows
                $aCountRowParams = [
                ...
                $this->nRows = $this->Rptinventory_model->FSnMCountDataReportAll($aCountRowParams);
    ...
    public function FSvCCallRptViewBeforePrint() {
        try {
            ...
            $aDataReport = $this->Rptinventory_model->FSaMGetDataReport($aDataReportParams);
            /** =========== End Get Data ===================================== */
            /** =========== Begin Render View ================================ */
    ...
    public function FSoCChkDataReportInTableTemp() {
        try {
            ...
            $nDataCountPage = $this->Rptinventory_model->FSnMCountRowInTemp($aDataCountData);
