...
class Province_controller extends MX_Controller {
    ...
    public function FSvPVNDataList(){
        ...
        $tAPIReq    = "";
        $tMethodReq = "GET";
        $aResList   = $this->Province_model->FSaMPVNList($tAPIReq,$tMethodReq,$aData);
    ...
    public function FSvPVNEditPage(){
        ...
        $tAPIReq        = "";
        $tMethodReq     = "GET";
        $aPvnData       = $this->Province_model->FSaMPVNSearchByID($tAPIReq,$tMethodReq,$aData);
    ...
    public function FSaPVNAddEvent(){
        try{
            ...
            $oCountDup  = $this->Province_model->FSnMPVNCheckDuplicate($aDataMaster['FTPvnCode']);
            $nStaDup    = $oCountDup[0]->counts;
            if($nStaDup == 0){
                $this->db->trans_begin();
                $aStaPvnMaster  = $this->Province_model->FSaMPVNAddUpdateMaster($aDataMaster);
                $aStaPvnLang    = $this->Province_model->FSaMPVNAddUpdateLang($aDataMaster);
    ...
    public function FSaPVNDeleteEvent(){
        ...
        $tMethodReq     = 'POST';
        $aResDel        = $this->Province_model->FSnMPVNDel($tAPIReq,$tMethodReq,$aDataMaster);
        $nNumRowPvnLoc  = $this->Province_model->FSnMLOCGetAllNumRow();
