...
class Docregen_controller extends MX_Controller {
    ...
    */
    ...
    public function __construct() {
        $this->load->model('tool/log/Docregen_model');
        parent::__construct();
    }
    ...
    public function index(){
        ...
        $this->load->view('tool/log/docregen/wDocRegen');
    }
    ...
    // Return : String View
    // Return Type : View
    public function FSvCDRGMainPage(){
        ...
        $this->load->view('tool/log/docregen/wDocRegenMain',$aDataConfigView);
    }



    public function FSvCDRGDataTable(){
        ...
        $aListData = array(
            'aTotalSaleByBranchData' => $this->Docregen_model->FSaMDRGDataTable($aData),
            'nPage'         => $nPage,
        );
        // echo '<pre>';
        ...
        // echo '<pre>';
        // die();
        $this->load->view('tool/log/docregen/wDocRegenDataTable',$aListData);
    ...
    public function FSvCRPNCallMQPrc(){
        try{
            ...
            $aReturn = array(
                'nStaEvent'    => '900',
                'tStaMessg'    => language('tool/log/tool', 'tToolMassageError')
            );
            echo json_encode($aReturn);
            return;
        }
