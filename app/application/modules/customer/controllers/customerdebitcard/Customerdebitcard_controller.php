...
class Customerdebitcard_controller extends MX_Controller {
    public function __construct() {
        parent::__construct ();
        $this->load->model('customer/customerdebitcard/Customerdebitcard_model');
    ...
    public function FSvCCstDebitDataList(){
        ...
        $aResList    = $this->Customerdebitcard_model->FSaMCstDebitCardDataList($aData);
    ...
    public function FSvCCstDebitPageEdit(){
        ...
        // TFNMCardMan
        $aResult    = $this->Customerdebitcard_model->FSaMCstDebitCardCheckID($aData);
    ...
    public function FSaCCstDebitAddEvent(){
        try{
          ...
          $aChkCrdCode  = $this->Customerdebitcard_model->FSaMCstCheckCrdCode($aDataAdd);
        ...
        if($aChkCrdCode['rtCode'] == 1){
          ...
          $aStaCtyMaster  = $this->Customerdebitcard_model->FSaMCSTAddUpdateMaster($aDataAdd);
    ...
    public function FSaCCstDebitDeleteEvent(){
        ...
        $aResDel        = $this->Customerdebitcard_model->FSnMCstDebitCard($aDataMaster);
        $nNumRowRsnLoc  = $this->Customerdebitcard_model->FSnMCstDebitCrdGetAllNumRow();
