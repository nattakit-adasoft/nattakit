...
class Customeraddress_controller extends MX_Controller {

    public function __construct() {
        parent::__construct ();
        $this->load->model('customer/customer/Customeraddress_model');
    ...
    public function FSvCCSTAddressDataTable(){
        ...
        $aCustomerDataAddress   = $this->Customeraddress_model->FSaMCSTAddressDataList($aDataWhere);
    ...
    public function FSvCCSTAddressCallPageAdd(){
        ...
        $aCSTDataVersion    = $this->Customeraddress_model->FSaMCSTAddressGetVersion();
        $aDataViewAdd       = [
    ...
    public function FSvCCSTAddressCallPageEdit(){
        ...
        $aCSTDataVersion    = $this->Customeraddress_model->FSaMCSTAddressGetVersion();
        $aCSTDataAddress    = $this->Customeraddress_model->FSaMCSTAddressGetDataID($aDataWhereAddress);
        $aDataViewEdit      = [
    ...
    public function FSoCCSTAddressAddEvent(){
        try{
            ...
            $this->Customeraddress_model->FSxMCSTAddressAddData($aCSTDataAddress);
            $this->Customeraddress_model->FSxMCSTAddressUpdateSeq($aCSTDataAddress);
    ...
    public function FSoCCSTAddressEditEvent(){
        try{
            ...
            $this->Customeraddress_model->FSxMCSTAddressEditData($aCSTDataAddress);
            $this->Customeraddress_model->FSxMCSTAddressUpdateSeq($aCSTDataAddress);
    ...
    public function FSoCCSTAddressDeleteEvent(){
        try{
            ...
            $this->Customeraddress_model->FSaMCSTAddressDelete($aDataWhereDelete);
            $this->Customeraddress_model->FSxMCSTAddressUpdateSeq($aDataWhereDelete);
            if($this->db->trans_status() === FALSE){
                $this->db->trans_rollback();
                $aDataError = array(
                    'tCodeReturn'   => 500,
