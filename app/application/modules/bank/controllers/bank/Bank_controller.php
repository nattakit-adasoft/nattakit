...
class Bank_controller extends MX_Controller {
    public function __construct(){
        parent::__construct ();
        $this->load->model('bank/bank/Bank_model');
    ...
    public function FSvCBNKDataList(){
        try{
            ...
            $aBnkDataList     = $this->Bank_model->FSaMBNKList($aData);
    ...
    public function FSvCBNKEditPage(){
        try{
            ...
            $aBnkData   = $this->Bank_model->FSaMBnkGetDataByID($aData);
    ...
    public function FSoCBNKAddEvent(){
        try{
            ...
            $oCountDup  = $this->Bank_model->FSnMBNKCheckDuplicate($aDataMaster['FTBnkCode']);
            $nStaDup    = $oCountDup[0]->counts;
            if($nStaDup == 0){
                $this->db->trans_begin();
                $aStaEventMaster  = $this->Bank_model->FSaMBNKAddUpdateMaster($aDataMaster);
                $aStaEventLang    = $this->Bank_model->FSaMBNKAddUpdateLang($aDataMaster);
    ...
    public function FSoCBNKEditEvent(){
        try{
            ...
            $aStaEventMaster  = $this->Bank_model->FSaMBNKAddUpdateMaster($aDataMaster);
            $aStaEventLang    = $this->Bank_model->FSaMBNKAddUpdateLang($aDataMaster);
            $this->Bank_model->FSaMBNKAddImgObj($aDataMaster);
    ...
    public function FSoCBNKDeleteEvent(){
        ...
        $aResDel    = $this->Bank_model->FSaMBNKDelAll($aDataMaster);
        $nNumRowBnk = $this->Bank_model->FSnMBNKGetAllNumRow();
