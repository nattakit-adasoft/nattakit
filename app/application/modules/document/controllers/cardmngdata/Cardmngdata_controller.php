...
class Cardmngdata_controller extends CI_Controller {

    
    public function __construct(){
        parent::__construct();
        $this->load->model('document/cardmngdata/Cardmngdata_model');
    ...
    public function FSvCCMDExpFileDataList(){
        try{
            ...
            if($tCMDDataType == '2' && $tCMDDataList == '1' && is_array($aCMDDataCons)){
                ...
                $aCMDDataExport = $this->Cardmngdata_model->FSaMCMDGetDataCardExport($aData);
                $aRenderTable    = array(
    ...
    public function FSoCCMDProcessExport(){
        try{
            ...
            $aDataExport    = $this->Cardmngdata_model->FSoMCMDExpProcessData($aDataCons);
    ...
    public function FSaCProcessNewCard($tDocCode){
        try{
            ...
            $this->Cardmngdata_model->FSaMCMDInsertDocHD($tTableNameHD,$aDataInsertHD);
    ...
    public function FSaCProcessTopUp($tDocCode){
        try{
            ...
            $aVatCodeComp   = $this->Cardmngdata_model->FSaMCMDGetVatCodeCompany();
            $nTotalTopUp    = 0;
            ...
            $aStaInsertHD   = $this->Cardmngdata_model->FSaMCMDInsertDocHD($tTableNameHD,$aDataInsertHD);
