...
class Conditionredeem_controller extends MX_Controller {

    public function __construct() {
        date_default_timezone_set("Asia/Bangkok");
        $this->load->model('company/company/Company_model');
        $this->load->model('document/conditionredeem/Conditionredeem_model');
        parent::__construct();
    }
    ...
    public function FSoCRDHGetDataTable() {
        try{
            ...
            $aDataList      = $this->Conditionredeem_model->FSaMRDHGetDataTableList($aDataCondition);
            $aConfigView    = array(
                'nPage'             => $nPage,
    ...
    public function FSoCRDHCallPageAdd(){
        ...
        $this->Conditionredeem_model->FSxMRDHClearTempRedeemDefaultDT($aDataPdtParams);
    ...
    public function FSxCRDHClearConditionRedeemTmp(){
        ...
        $this->Conditionredeem_model->FSxMRDHClearTempRedeemDT($aDataPdtParams);
    ...
    public function FSoCRDHCallPageEdit(){
        ...
        $aResult       = $this->Conditionredeem_model->FSaMRDHGetDataByID($aData);
        $aResultCD     = $this->Conditionredeem_model->FSaMRDHGetDataCDByID($aData);
        $aResultBch    = $this->Conditionredeem_model->FSaMRDHGetDataBchByID($aData);
        $aResultCstPri = $this->Conditionredeem_model->FSaMRDHGetDataCstPriByID($aData);
        ...
        $this->Conditionredeem_model->FSaMRDHGenPdtInsertTempConditionRedeemDT($aDataGenPdtInsertTemp);
    ...
    public function FSoCRDHEventDelete(){
        try{
            ...
            $aResDelDoc     = $this->Conditionredeem_model->FSnMRDHDelDocument($aDataMaster);
    ...
    public function FSoCRDHEventAdd(){
        try{
            ...
            $aDataWhereDTTmp = [
             ...
             $nLastNumber = $this->Conditionredeem_model->FSnMGetMaxCodeCDConditionRedeem();
          ...
          //สาขา
            ...
            $this->db->trans_begin();
            $this->Conditionredeem_model->FSaMRDHAddUpdateConditionRedeemHD($aDataConditionRedeemHD,$aDataWhere);
            $this->Conditionredeem_model->FSaMRDHAddUpdateConditionRedeemHDL($aDataConditionRedeemHD_L);

            $this->Conditionredeem_model->FSaMRDHAddUpdateConditionRedeemDT($aDataConditionRedeemPdtDT);

            $this->Conditionredeem_model->FSaMRDHAddUpdateConditionRedeemCD($aDataConditionRedeemGRP,$aDataConditionRedeemDT);

            $this->Conditionredeem_model->FSaMRDHAddUpdateConditionRedeemHDBch($aDataConditionRedeemCRBch,$aDataConditionRedeemDT);
            $this->Conditionredeem_model->FSaMRDHAddUpdateConditionRedeemHDCstPri($aDataConditionRedeemCRPpl,$aDataConditionRedeemDT);
    ...
    public function FSaCRDHEventCancel(){
        ...
        $this->Conditionredeem_model->FSaMRDHCancelStatus($aData);
    }
    ...
    public function FSaCRDHEventAppove(){
        ...
        $this->Conditionredeem_model->FSaMRDHAppoveStatus($aData);
    }
    ...
    public function FSaCRDHEventAddPdtTemp() {
        try {
            ...
            $nResultDuplicate = $this->Conditionredeem_model->FSxMRDHFindDuplicatePdt($aDataPdtParams);
            ...
            $bStaInsPdtToTmp  = $this->Conditionredeem_model->FSaMRDHInsertPDTToTemp($aDataPdtParams);
    ...
    public function FSaCRDHECallEventPdtTemp(){
        try {
            ...
            $aDataDocDTTemp = $this->Conditionredeem_model->FSaMRDHGetDocDTTempListPage($aDataWhere);
    ...
    public function FSaCRDHPdtAdvanceTableDeleteSingle(){
        try {
           ...
           $aResult = $this->Conditionredeem_model->FSaMRDHPdtAdvanceTableDeleteSingle($aDataParam);
    ...
    public function FSaCRDHInsertGrpNamePDTToTemp(){
        try {
            ...
            $aResult = $this->Conditionredeem_model->FSaMRDHInsertGrpNamePDTToTemp($aDataPdtParams);
    ...
    public function FSaCRDHGetGrpNamePDTToTemp(){
        try {
            ...
            $aResult = $this->Conditionredeem_model->FSaMRDHGetGrpNamePDTToTemp($aDataPdtParams);
    ...
    public function FSaCRDHSetPdtGrpDTTemp(){
        try {
            ...
            $aResult = $this->Conditionredeem_model->FSaMRDHSetPdtGrpDTTemp($aDataPdtParams);
    ...
    public function FSaCRDHDelGroupInDTTemp(){
        try {
            ...
            $aResult = $this->Conditionredeem_model->FSaMRDHDelGroupInDTTemp($aDataPdtParams);
    ...
    public function FSaCRDHChangStatusAfApv(){
        ...
        $aResult = $this->Conditionredeem_model->FSaMRDHChangStatusAfApv($aDataPdtParams);
           if($aResult['rtCode']=="1"){
                $aReturnData = array(
                    'nStaEvent' => '1',
                    'tStaMessg' => "Fucntion Success"
