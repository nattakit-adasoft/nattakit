...
class Cardshiftout_controller extends MX_Controller {
    
    public function __construct(){
        parent::__construct();
        $this->load->model('document/cardshiftout/Cardshiftout_model');
    ...
    public function FSvCardShiftOutDataList(){
        ...
        $tAPIReq = "";
        $tMethodReq = "GET";
        $aResList = $this->Cardshiftout_model->FSaMCardShiftOutList($tAPIReq, $tMethodReq, $aData);
        $aAlwEvent = FCNaHCheckAlwFunc('cardShiftOut/0/0');
        $aGenTable = array(
            'aAlwEvent' => $aAlwEvent,
            'aDataList' => $aResList,
    ...
    public function FSvCardShiftOutEditPage(){
        ...
        $tAPIReq = "";
        $tMethodReq = "GET";
        $aCardShiftOutData = $this->Cardshiftout_model->FSaMCardShiftOutSearchByID($tAPIReq, $tMethodReq, $aData);
        ...
        // $aCardShiftOutCardDataInDT = $this->Cardshiftout_model->FSaMCardShiftOutGetDTByDocNo($aData);
    ...
    public function FSaCardShiftOutAddEvent(){
        try{
            ...
            $oCountDup  = $this->Cardshiftout_model->FSoMCardShiftOutCheckDuplicate($aDataMaster['FTCshDocNo']);
            $nStaDup    = $oCountDup[0]->counts;

            if($nStaDup == 0){
                $this->db->trans_begin();

                $aStaCardShiftOutHD = $this->Cardshiftout_model->FSaMCardShiftOutAddUpdateHD($aDataMaster);
    ...
    public function FSaCardShiftOutEditEvent(){
        try{
            ...
            $aCardShiftOutHD = $this->Cardshiftout_model->FSaMCardShiftOutSearchByID("", "", $aDataMaster);
    ...
    public function FSaCardShiftOutUpdateApvDocAndCancelDocEvent(){
        try{
            ...
            {
                $aStaCardShiftOutHD = $this->Cardshiftout_model->FSaMCardShiftOutUpdateApvDocAndCancelDocHD($aDataMaster);
    ...
    public function FSaCardShiftOutDeleteEvent(){
        ...
        $aResDel = $this->Cardshiftout_model->FSnMCardShiftOutDel($aDataMaster);
        $aReturn = array(
    ...
    public function FStCardShiftOutUniqueValidate($tSelect = ''){
        ...
        if($this->input->is_ajax_request()){ // Request check
            if($tSelect == 'cardShiftOutCode'){
                ...
                $oCustomerGroup = $this->Cardshiftout_model->FSoMCardShiftOutCheckDuplicate($tCardShiftOutCode);
    ...
    public function FSoCardShiftOutDeleteMulti(){
        ...
        foreach($aCardShiftOutCode as $oCardShiftOutCode){
            ...
            $this->Cardshiftout_model->FSnMCardShiftOutDel($aCardShiftOut);
        }
