...
class Cardshiftstatus_controller extends MX_Controller {
    
    public function __construct(){
        parent::__construct();
        $this->load->model('document/cardshiftstatus/Cardshiftstatus_model');
    ...
    public function FSvCardShiftStatusDataList(){
        ...
        $tAPIReq = "";
        $tMethodReq = "GET";
        $aResList = $this->Cardshiftstatus_model->FSaMCardShiftStatusList($tAPIReq, $tMethodReq, $aData);
        $aAlwEvent = FCNaHCheckAlwFunc('cardShiftStatus/0/0');
        $aGenTable = array(
            'aAlwEvent' => $aAlwEvent,
            'aDataList' => $aResList,
    ...
    public function FSvCardShiftStatusEditPage(){
        ...
        $tAPIReq = "";
        $tMethodReq = "GET";
        $aCardShiftStatusData = $this->Cardshiftstatus_model->FSaMCardShiftStatusSearchByID($tAPIReq, $tMethodReq, $aData);
        ...
        // $aCardShiftStatusCardDataInDT = $this->Cardshiftstatus_model->FSaMCardShiftStatusGetDTByDocNo($aData);
    ...
    public function FSaCardShiftStatusAddEvent(){
        try{
            ...
            $oCountDup  = $this->Cardshiftstatus_model->FSoMCardShiftStatusCheckDuplicate($aDataMaster['FTCvhDocNo']);
            $nStaDup    = $oCountDup[0]->counts;
            
            if($nStaDup == 0){
                $this->db->trans_begin();
                
                $aStaCardShiftStatusHD = $this->Cardshiftstatus_model->FSaMCardShiftStatusAddUpdateHD($aDataMaster);
    ...
    public function FSaCardShiftStatusEditEvent(){
        try{
            ...
            $aCardShiftStatusHD = $this->Cardshiftstatus_model->FSaMCardShiftStatusSearchByID("", "", $aDataMaster);
            if( 
    ...
    public function FSaCardShiftStatusUpdateApvDocAndCancelDocEvent(){
        try{
            ...
            {
                $aStaCardShiftStatusHD = $this->Cardshiftstatus_model->FSaMCardShiftStatusUpdateApvDocAndCancelDocHD($aDataMaster);
    ...
    public function FSaCardShiftStatusDeleteEvent(){
        ...
        $aResDel = $this->Cardshiftstatus_model->FSnMCardShiftStatusDel($aDataMaster);
        $aReturn = array(
    ...
    public function FStCardShiftStatusUniqueValidate($tSelect = ''){
        ...
        if($this->input->is_ajax_request()){ // Request check
            if($tSelect == 'cardShiftStatusCode'){
                ...
                $oCustomerGroup = $this->Cardshiftstatus_model->FSoMCardShiftStatusCheckDuplicate($tCardShiftStatusCode);
    ...
    public function FSoCardShiftStatusDeleteMulti(){
        ...
        foreach($aCardShiftStatusCode as $oCardShiftStatusCode){
            ...
            $this->Cardshiftstatus_model->FSnMCardShiftStatusDel($aCardShiftStatus);
        }
