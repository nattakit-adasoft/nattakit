...
class Promotionstep4chncondition_controller extends MX_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->model('document/promotion/Promotionstep4chncondition_model');
    ...
    public function FSxCPromotionGetHDChnInTmp()
    {
        ...
        $aResList = $this->Promotionstep4chncondition_model->FSaMGetPdtPmtHDChnInTmp($aGetPdtPmtHDCstPriInTmpParams);
    ...
    public function FSaCPromotionInsertChnToTmp()
    {
        ...
        $this->Promotionstep4chncondition_model->FSaMPdtPmtHDChnToTemp($aPdtPmtHDCstPriToTempParams);
    ...
    public function FSxCPromotionUpdateChnInTmp()
    {
        ...
        $this->Promotionstep4chncondition_model->FSbUpdateChnInTmpByKey($aUpdatePmtCBInTmpBySeqParams);
    ...
    public function FSxCPromotionDeleteChnInTmp()
    {
        ...
        $this->Promotionstep4chncondition_model->FSbDeletePdtPmtHDChnInTmpByKey($aDeleteInTmpByKeyParams);
