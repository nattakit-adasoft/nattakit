...
class Promotionstep2pmtdt_controller extends MX_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->model('document/promotion/Promotionstep2pmtdt_model');
    ...
    public function FSxCPromotionGetPmtDtGroupNameInTmp()
    {
        ...
        $aResList = $this->Promotionstep2pmtdt_model->FSaMGetPmtDtGroupInTmp($aGetPmtDtInTmpParams);
    ...
    public function FStCPromotionGetPmtCBInTmp()
    {
        ...
        $aPmtCBInTmp = $this->Promotionstep2pmtdt_model->FSaMGetPmtCBInTmp($aGetPmtCBInTmpParams);
    ...
    public function FStCPromotionGetPmtCGInTmp()
    {
        ...
        $aPmtCGInTmp = $this->Promotionstep2pmtdt_model->FSaMGetPmtCGInTmp($aGetPmtCGInTmpParams);
