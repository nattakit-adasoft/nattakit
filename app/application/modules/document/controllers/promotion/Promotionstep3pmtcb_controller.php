...
class Promotionstep3pmtcb_controller extends MX_Controller
{
    ...
    public function FSxCPromotionGetPmtCBInTmp()
    {
        ...
        $aResList = $this->Promotionstep3pmtcb_model->FSaMGetPmtCBInTmp($aGetPmtCBInTmpParams);
    ...
    public function FSxCPromotionUpdatePmtCBInTmp()
    {
        ...
        if($tStaBuyIsRange == "1"){ // 1:is range
            ...
            $cPgtPerAvgDis = $this->Promotionstep3pmtcb_model->FScMGetPmtCBAndPmtCGPgtPerAvgDisOnCBInTmp($aGetPmtCBAndPmtCGPgtPerAvgDisInTmpParams);
        ...
        $aUpdateRes = $this->Promotionstep3pmtcb_model->FSbUpdatePmtCBInTmpBySeq($aUpdatePmtCBInTmpBySeqParams);
    ...
    public function FSaCPromotionInsertPmtCBToTmp()
    {
        ...
        $this->Promotionstep3pmtcb_model->FSbDeletePmtCBInTmpByGroupName($aDeletePmtCBInTmpByGroupNameParams);
        ...
        $this->Promotionstep3pmtcb_model->FSaMPmtCBToTemp($aPmtCBToTempParams);
    ...
    public function FSxCPromotionUpdatePmtCBRangeInTmp()
    {
        ...
        $this->Promotionstep3pmtcb_model->FSbUpdatePmtCBInTmpBySeq($aUpdatePmtCBInTmpBySeqParams);
    ...
    public function FSaCPromotionInsertPmtCBAndPmtCGToTmp()
    {
        ...
        $this->Promotionstep3pmtcb_model->FSaMPmtCBWithPmtCGPmtCBToTemp($aPmtCBWithPmtCGToTempParams);
        $this->Promotionstep3pmtcb_model->FSaMPmtCBWithPmtCGPmtCGToTemp($aPmtCBWithPmtCGToTempParams);
    ...
    public function FSaCPromotionDeletePmtCBAndPmtCGInTmpBySeq()
    {
        ...
        $this->Promotionstep3pmtcb_model->FSbDeletePmtCBAndCGInTmpBySeq($aDeletePmtCBInTmpByGroupNameParams);
    ...
    public function FSxCPromotionGetPmtCBWithPmtCGInTmp()
    {
        ...
        $aResList = $this->Promotionstep3pmtcb_model->FSaMGetPmtCBWithPmtCGInTmp($aGetPmtCBInTmpParams);
    ...
    public function FSxCPromotionUpdatePmtCGAndPmtCBPerAvgDisInTmp()
    {
        ...
        $this->Promotionstep3pmtcb_model->FSbUpdateCGAndCBPerAvgDisInTmp($UpdateCGAndCBPerAvgDisInTmp);
    }
}