...
class Promotionstep4pricegroupcondition_controller extends MX_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->model('document/promotion/Promotionstep4pricegroupcondition_model');
    ...
    public function FSxCPromotionGetPdtPmtHDCstPriInTmp()
    {
        ...
        $aResList = $this->Promotionstep4pricegroupcondition_model->FSaMGetPdtPmtHDCstPriInTmp($aGetPdtPmtHDCstPriInTmpParams);
    ...
    public function FSaCPromotionInsertPriceGroupToTmp()
    {
        ...
        $this->Promotionstep4pricegroupcondition_model->FSaMPdtPmtHDCstPriToTemp($aPdtPmtHDCstPriToTempParams);
    ...
    public function FSxCPromotionUpdatePriceGroupInTmp()
    {
        ...
        $this->Promotionstep4pricegroupcondition_model->FSbUpdatePriceGroupInTmpByKey($aUpdatePmtCBInTmpBySeqParams);
    ...
    public function FSxCPromotionDeletePriceGroupInTmp()
    {
        ...
        $this->Promotionstep4pricegroupcondition_model->FSbDeletePdtPmtHDCstPriInTmpByKey($aDeleteInTmpByKeyParams);
