...
class Purchaseinvoicedischgmodal_controller extends MX_Controller {
    ...
    public function FSoCPIDisChgHDList(){
        try{
            ...
            $aDataList  = $this->Purchaseinvoicedischgmodal_model->FSaMPIGetDisChgHDList($aDataCondition);
    ...
    public function FSoCPIDisChgDTList(){
        try{
            ...
            $aDataList      = $this->Purchaseinvoicedischgmodal_model->FSaMPIGetDisChgDTList($aDataCondition);
    ...
    public function FSoCPIAddEditDTDis(){
        try{
            ...
            // ================================ Begin DB Process ================================
                ...
                $this->Purchaseinvoicedischgmodal_model->FSaMPIClearDisChgTxtDTTemp($aParams);
                $this->Purchaseinvoicedischgmodal_model->FSaMPIDeleteDTDisTemp($aParams);
                ...
                if(isset($aDisChgItems) && !empty($aDisChgItems)){
                    ...
                    $aResAddEditDTDisTemp   = $this->Purchaseinvoicedischgmodal_model->FSaMPIAddEditDTDisTemp($aInsertDTDisTmp);
                }
            // ==================================================================================
    ...
    public function FSoCPIAddEditHDDis(){
        try{
            ...
            $this->Purchaseinvoicedischgmodal_model->FSaMPIDeleteHDDisTemp($aParams);
            ...
            $this->db->trans_begin();
                ...
                if(isset($aDisChgItems) && !empty($aDisChgItems)){
                    ...
                    $this->Purchaseinvoicedischgmodal_model->FSaMPIAddEditHDDisTemp($aInsertHDDisTmp);
                }
            // ==================================================================================
            if($this->db->trans_status() === FALSE){
                $this->db->trans_rollback();
