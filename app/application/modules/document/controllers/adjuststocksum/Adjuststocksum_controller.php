...
class Adjuststocksum_controller extends MX_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('document/adjuststocksum/Adjuststocksum_model');
    }
    ...
    public function FSoCSMGetDataTable() {
        try{
            ...
            $aDataList      = $this->Adjuststocksum_model->FSaMAdjStkSumDataTableList($aDataCondition);
            $aConfigView    = array(
                'nPage'             => $nPage,
    ...
    public function FSoCSMCallPageAdd(){
        ...
        // );
        $this->Adjuststocksum_model->FSxMClearPdtInTmp();
        // $this->Conditionredeem_model->FSxMSMClearTempRedeemDefaultDT($aDataPdtParams);
    ...
    public function FSoCSMCallPageEdit(){
        ...
        $this->Adjuststocksum_model->FSxMClearPdtInTmp();
        // $this->Conditionredeem_model->FSxMSMClearTempRedeemDefaultDT($aDataPdtParams);
        $aDataDocHD = $this->Adjuststocksum_model->FSaMAdjStkSumGetHD($aDataPdtParams);
        $this->Adjuststocksum_model->FSaMAdjStkSumInsertDTToTemp($aDataPdtParams);
        $aDataConfigViewAdd = [
            'nOptDecimalShow'   => $nOptDecimalShow,
            'nOptDocSave'       => $nOptDocSave,
            'tUserBchCode'      => $tSMBchCode,
    ...
    public function FSoCSMCallTableLoadData(){
        ...
        $aDataDT = $this->Adjuststocksum_model->FSaMAdjStkSumGetDTTempListPage($aDataWhere);

        // $aDataDTSum = $this->Adjuststocksum_model->FSaMAdjStkSumSumDTTemp($aDataWhere);
    ...
    public function FSoCSMEventEditInLine(){
        ...
        $aResDel = $this->Adjuststocksum_model->FSnMAdjStkSumUpdateInlineDTTemp($aDataUpdate,$aDataMaster);
        ...
        $aResBal = $this->Adjuststocksum_model->FSnMAdjStkSumFine4BalanceDTTemp($aDataFine4Balance);
    ...
    public function FSvCEventRemovePdtInDTTmp(){
        ...
        $aResDel = $this->Adjuststocksum_model->FSnMAdjStkSumDelDTTmp($aDataWhere);
    ...
    public function FSoCSMEventCallPdtStkSum(){
        ...
        $aReuslt =  $this->Adjuststocksum_model->FSaMAdjStkSumInsertPDTToTemp($aDataWhere);
        $aDocRef =  $this->Adjuststocksum_model->FSaMAdjStkSumFindDocRef($aDataWhere);
    ...
    public function FSvCEventRemoveMultiPdtInDTTmp(){
        ...
        if($nCount > 1){
            ...
            for($i=0; $i<$nCount; $i++){
                ...
                $aResDel = $this->Adjuststocksum_model->FSaMAdjStkSumPdtTmpMultiDel($aDataMaster);
            }
    ...
    public function FSoCSMEventAdd(){
        try{
            ...
            $this->Adjuststocksum_model->FSaMAjhAddUpdateHD($aDataAdjStkSum);
            $this->Adjuststocksum_model->FSaMAjhAddUpdateDT($aDataAdjStkSum);
            ...
            $this->Adjuststocksum_model->FSaMAjhUpdateRefDocStockSubHD($aUpdateRefDocSub);
    ...
    public function FSaCSMEventAppove(){
        ...
        $this->Adjuststocksum_model->FSaMUpdateDTBal($aUpdateBal);

        $aStaApv = $this->Adjuststocksum_model->FSvMAdjStkSumApprove($aDataUpdate); 
    ...
    public function FSaCSMEventCancel(){
        ...
        $aStaApv = $this->Adjuststocksum_model->FSvMAdjStkSumCancel($aDataUpdate); 
    ...
    public function FSaCSMEventDelete(){
        ...
        $aResDel    = $this->Adjuststocksum_model->FSnMAdjStkSumDel($aDataMaster);
        $aReturn    = array(
            'nStaEvent' => $aResDel['rtCode'],
            'tStaMessg' => $aResDel['rtDesc']
        );
