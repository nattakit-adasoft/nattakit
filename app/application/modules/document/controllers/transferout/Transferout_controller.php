...
class Transferout_controller extends MX_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('document/transferout/Transferout_model');
    }
    ...
    public function FSxCTXODataTable(){
        try{
            ...
            $aDataList      = $this->Transferout_model->FSaMTXOGetDataTable($aDataCondition);
    ...
    public function FSoCTXODeleteEventDoc(){
        try{
            ...
            $aResDelDoc = $this->Transferout_model->FSnMTXODelDocument($aDataMaster);
    ...
    public function FSoCTXOAddPage(){
        try{
            ...
            $this->Transferout_model->FSxMTXOClearPdtInTmp($tTblSelectData);
            // Get Option Show Decimal  
            $nOptDecimalShow    = FCNxHGetOptionDecimalShow(); 
            // Get Option Doc Save
            ...
            $aDataUserGroup = $this->Transferout_model->FSaTXOGetShpCodeForUsrLogin($aDataShp);
    ...
    public function FSoCTXOPdtAdvTblLoadData(){
        try{
            ...
            $aDataDT            = $this->Transferout_model->FSaMTXOGetDTTempListPage($aDataWhere);
            $aDataDTSum         = $this->Transferout_model->FSaMTXOSumDTTemp($aDataWhere);
    ...
    public function FSnCTXOCalulateDTTemp($ptTXODocNo,$ptTXOVATInOrEx,$ptTXODocType){
        ...
        //Get DT Tmp
        $aTXODataDTTmp  = $this->Transferout_model->FSaMTXOGetDTTemp($aDataWhere);
        ...
        if(isset($aTXODataDTTmp['rtCode']) &&  $aTXODataDTTmp['rtCode'] == '1'){
            ...
            $aResUpd = $this->Transferout_model->FSnMTXOUpdateDTTemp($aTXODataDTTmp,$aDataWhere);
        }
    }
    ...
    public function FSoCTXOVatLoadData(){
        try{
            ...
            $aDataVatDT         = $this->Transferout_model->FSaMTXOGetVatDTTemp($aDataWhere);
            // Get Data DT Tmp
            $aDataDTTmp         = $this->Transferout_model->FSaMTXOGetDTTemp($aDataWhere);
    ...
    public function FSoCTXOAddPdtIntoTableDTTmp(){
        ...
        $nCounts = $this->Transferout_model->FSnMTXOGetCountDTTemp($aDataWhere);
        ...
        foreach($aTXOPdtDataReturn AS $nKey => $aValue){
            ...
            $aDataPdtMaster     = $this->Transferout_model->FSaMTXOGetDataPdt($aDataPdtWhere);
            $nStaInsPdtToTmp    = $this->Transferout_model->FSaMTXOInsertPDTToTmp($aDataPdtMaster,$aDataPdtWhere);
        }
    ...
    public function FSoCTXOEditPdtIntoTableDTTmp(){
        try{
            ...
            //Edit Inline
            $aResUpdDTTmpInline = $this->Transferout_model->FSaMTXOUpdateInlineDTTmp($aDataUpdateDT, $aDataWhere);
            $aReturnData = array(
    ...
    public function FSoCTXORemovePdtInDTTmp(){
        try{
            ...
            $aDataDelPdtInDtTemp    = $this->Transferout_model->FSaMTXOPdtDeleteInDtTmp($aDataWhere);
            $aReturnData = array(
        ...
        try{
            ...
            if($nCountSeqData > 1){
                for($i = 0; $i < $nCountSeqData; $i++){
                    ...
                    $aResDel = $this->Transferout_model->FSxMTXODelMultiDTTmp($aDataMaster);
                }
            }
    ...
    public function FSoCTXOChkHavePdtForTnf(){
        try{
            ...
            $nCountPdtInDtTmp   = $this->Transferout_model->FSnMTXOChkPdtDtTmpForTnf($aDataWhere);
    ...
    public function FSoCTXOAddEventDoc(){
        try{
            ...
            $aStaInsHD      = $this->Transferout_model->FSaMTXOAddUpdateHD($aDataMaster,$aDataWhere,$aTableAddUpdate);
            // // Add Update Document HD Ref
            $aStaInsHDRef   = $this->Transferout_model->FSaMTXOAddUpdateHDRef($aDataHDRef,$aDataWhere,$aTableAddUpdate);
            // // Update Doc No Into Doc Temp
            $aStaUpdDocNoInDT   = $this->Transferout_model->FSaMTXOAddUpdateDocNoInDocTemp($aDataWhere,$aTableAddUpdate);
            // // Move Doc Tmp To DT
    ...
    public function FSxCTXOAddTmpToDT($paDataWhere,$paTableAddUpdate){
        ...
        $this->Transferout_model->FSaMTXOInsertTmpToDT($paDataWhere,$paTableAddUpdate);
        return;
    }
    ...
    public function FSxCTXOSumDTIntoHD($paDataWhere,$paTableAddUpdate){
        ...
        $aDataDTDoc = $this->Transferout_model->FSaMTXOGetDTDocument($aData,$paTableAddUpdate);
        $FCXthTotal = 0;
        ...
        $this->Transferout_model->FSnMTXOUpdateHDFCXthTotal($aDataUpdTotalHD,$paDataWhere,$paTableAddUpdate);
    }
    ...
    public function FSoCTXOClearDataDocTemp(){
        try{
            ...
            $this->Transferout_model->FSaMTXOClearDataDocTemp($aDataWhere);
    ...
    public function FSoCTXOEditPage(){
        try{
            ...
            $aDataDocHD     = $this->Transferout_model->FSaMTXOGetDataDocHD($aDataWhere);
            // Get Data Document HD Ref
            $aDataDocHDRef  = $this->Transferout_model->FSaMTXOGetDataDocHDRef($aDataWhere);
            // Get Data Document DT
            $aDataDocDT     = $this->Transferout_model->FSaMTXOGetDTDocument($aDataWhere,$aTableAddUpdate);
            // Move DT Insert To DocDTTemp
            $aStaIns        = $this->Transferout_model->FSaMTXOInsertDTToTemp($aDataDocDT,$aTableAddUpdate);
    ...
    public function FSoCTXOCheckViaCodeForApv(){
        ...
        $aResultChkVia  = $this->Transferout_model->FSaMTXOCheckViaCodeForApv($aDataWhere);
    ...
    public function FSoCTXOApproveDocument(){
        ...
        $aStaDocApv     = $this->Transferout_model->FSaMTXOApproveDocument($aDataUpdate,$aDataTableAppove);
        $this->db->trans_begin();
        try{
            $aMQParams  = [
