...
class Creditnotedischgmodal_controller extends MX_Controller {
    ...
    public function FSoCreditNoteDisChgHDList(){
        try{
            ...
            $aDataList = $this->Creditnotedischgmodal_model->FSaMCreditNoteGetDisChgHDList($aDataCondition);
    ...
    public function FSoCreditNoteDisChgDTList(){
        try{
            ...
            $aDataList  = $this->Creditnotedischgmodal_model->FSaMCreditNoteGetDisChgDTList($aDataCondition);
    ...
    public function FSvCCreditNoteAddEditHDDis(){
        ...
        if(!empty($aDisChgItems)){
            foreach ($aDisChgItems as $key => $item) {
                $this->Creditnotedischgmodal_model->FSaMCreditNoteAddEditHDDisTemp($aParams, $item);
            }
    ...
    public function FSvCCreditNoteAddEditDTDis(){
        ...
        $this->Creditnotedischgmodal_model->FSaMCreditNoteClearDisChgTxtDTTemp($aParams);
        $this->Creditnotedischgmodal_model->FSaMCreditNoteDeleteDTDisTemp($aParams);
        
        if(!empty($aDisChgItems)){
            foreach ($aDisChgItems as $key => $item) {
                $aResAddEditDTDisTemp = $this->Creditnotedischgmodal_model->FSaMCreditNoteAddEditDTDisTemp($aParams, $item);
            }
        }
    ...
    public function FSaCCENGetPriceAlwDiscount(){
        ...
        $nTotal = $this->Creditnotedischgmodal_model->FSaMCENGetPriceAlwDiscount($aWhere);
        $aTotal = array(
            'nTotal' => $nTotal['Total']
        );
