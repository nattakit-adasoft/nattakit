...
class cCardShiftReturn extends MX_Controller {
    ...
    public function FSvCardShiftReturnEditPage(){
        ...
        //$aCardShiftReturnCardDataInDT = $this->mCardShiftReturn->FSaMCardShiftReturnGetDTByDocNo($aData);
    ...
    public function FSaCardShiftReturnAddEvent(){
        try{
            ...
            $oCountDup  = $this->mCardShiftReturn->FSoMCardShiftReturnCheckDuplicate($aDataMaster['FTCshDocNo']);
