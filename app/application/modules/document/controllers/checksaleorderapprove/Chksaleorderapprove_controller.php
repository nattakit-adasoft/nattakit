...
class Chksaleorderapprove_controller extends MX_Controller {

    public function __construct() {
        date_default_timezone_set("Asia/Bangkok");
        parent::__construct();
        $this->load->model('document/checksaleorderapprove/Chksaleorderapprove_model');
    ...
    public function FSvCCHKSoCallPageMain(){
        ...
        //Get Data of SOHD
        $aResultData    = $this->Chksaleorderapprove_model->FSaMCHKSoGetDetailData($aDataCondition);

        //Get Data Loop for Seq 1-6
        $aResultSeq = $this->Chksaleorderapprove_model->FSaMCHKSoGetdataloop($aDataCondition);
        ...
        $nSetLimitTimeReloadPageMain = $this->Chksaleorderapprove_model->FSnMCHKSoGetTimeMonitorCountDown();
