...
class Couponsetup_controller extends MX_Controller {

    public function __construct() {
        date_default_timezone_set("Asia/Bangkok");
        $this->load->model('company/company/Company_model');
        $this->load->model('document/couponsetup/Couponsetup_model');
        parent::__construct();
    }
    ...
    public function FSoCCPHGetDataTable() {
        try{
            ...
            $aDataList      = $this->Couponsetup_model->FSaMCPHGetDataTableList($aDataCondition);
            $aConfigView    = array(
                'nPage'             => $nPage,
    ...
    public function FSoCCPHCallPageEdit(){
        ...
        $aResult    = $this->Couponsetup_model->FSaMCCPGetDataByID($aData);
        // print_r($aResult);
        // die();
        $aDataEdit  = [
            'aDataDocHD'    => $aResult,
    ...
    public function FSoCCPHCallPageDetailDT(){
        try{
            ...
            $aDataDetailDT      = $this->Couponsetup_model->FSaMCPHGetDataDetailDT($aDataWhere);
            $aDataRenderView    = [
    ...
    public function FSoCCPHEventDelete(){
        try{
            ...
            $aResDelDoc     = $this->Couponsetup_model->FSnMCPHDelDocument($aDataMaster);
    ...
    public function FSoCCPHEventAdd(){
        try{
            ...
            $this->Couponsetup_model->FSaMCCPAddUpdateCouponHD($aDataCouponHD,$aDataWhere);
            $this->Couponsetup_model->FSaMCCPAddUpdateCouponHDL($aDataCouponHD_L);
            $this->Couponsetup_model->FSaMCCPAddUpdateCouponDT($aDetailItems,$aDataCouponDT);
            $this->Couponsetup_model->FSaMCCPAddUpdateCouponHDCstPri($aDataCouponDT,$aDataCouponHDCstPri);
            $this->Couponsetup_model->FSaMCCPAddUpdateCouponHDPdt($aDataCouponDT,$aDataCouponHDPdt);
            $this->Couponsetup_model->FSaMCCPAddUpdateCouponHDBch($aDataCouponDT,$aDataCouponHDBch);
    ...
    public function FSaCCPHEventCancel(){
        ...
        $this->Couponsetup_model->FSaMCPHCancelStatus($aData);
    }
    ...
    public function FSaCCPHEventAppove(){
        ...
        $this->Couponsetup_model->FSaMCPHAppoveStatus($aData);
    }
