...
class Saleorderdischgmodal_controller extends MX_Controller {
    ...
    public function FSoCSODisChgHDList(){
        try{
            ...
            $aDataList  = $this->Saleorderdischgmodal_model->FSaMSOGetDisChgHDList($aDataCondition);
            // echo '<pre>';
            // print_r($aDataList);
            // echo '</pre>';
            // die();
    ...
    public function FSoCSODisChgDTList(){
        try{
            ...
            $aDataList      = $this->Saleorderdischgmodal_model->FSaMSOGetDisChgDTList($aDataCondition);
    ...
    public function FSoCSOAddEditDTDis(){
        try{
            ...
            // ================================ Begin DB Process ================================
                ...
                $this->Saleorderdischgmodal_model->FSaMSOClearDisChgTxtDTTemp($aParams);
                $this->Saleorderdischgmodal_model->FSaMSODeleteDTDisTemp($aParams);
                ...
                if(isset($aDisChgItems) && !empty($aDisChgItems)){
                    ...
                    $aResAddEditDTDisTemp   = $this->Saleorderdischgmodal_model->FSaMSOAddEditDTDisTemp($aInsertDTDisTmp);
                }
            // ==================================================================================
    ...
    public function FSoCSOAddEditHDDis(){
        try{
            ...
            $this->Saleorderdischgmodal_model->FSaMSODeleteHDDisTemp($aParams);
            ...
            $this->db->trans_begin();
                ...
                if(isset($aDisChgItems) && !empty($aDisChgItems)){
                    ...
                    $this->Saleorderdischgmodal_model->FSaMSOAddEditHDDisTemp($aInsertHDDisTmp);
                }
            // ==================================================================================
            if($this->db->trans_status() === FALSE){
                $this->db->trans_rollback();
