    ...
    <div class="panel-heading">
        <section id="ostSearchPromotion">
            ...
            <div class="row hidden" id="odvAdjStkSumAdvanceSearchContainer" style="margin-bottom:20px;">
                    ...
                    <div class="col-lg-6 col-md-6 col-xs-6 no-padding padding-right-15">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <span class="input-group-btn" >
                                    <button id="obtAdjStkSumBrowseBchFrom" type="button" class="btn xCNBtnBrowseAddOn" >
                    ...
                    <div class="col-lg-6 col-md-6 col-xs-6 no-padding padding-left-15">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <!-- ถ้า user มีสาขาจะไม่สามารถ Brw ได้ -->
                                <span class="input-group-btn" >
                                    <button id="obtAdjStkSumBrowseBchTo" type="button" class="btn xCNBtnBrowseAddOn" >
                                        <img src="<?php echo base_url() . 'application/modules/common/assets/images/icons/find-24.png' ?>">
                                    </button>
                                </span>
                            </div>
                ...
                <div class="col-lg-12">
                    <a id="oahAdjStkSumAdvanceSearchSubmit" class="btn xCNBTNDefult xCNBTNDefult1Btn pull-right" href="javascript:;" onclick="JSvCallPageAdjStkSumPdtDataTable()"><?php echo language('common/main/main', 'tSearch'); ?></a>
                </div>
            </div>
        </section>
    </div>
