<div style="max-height:350px;overflow:auto;">
    <table class="table table-bordered table-striped" id="otbSOOrderListDetail">
        <thead>
            <tr class="xCNCenter">
...
<div style="padding:10px 0px;"><input type="checkbox" id="ocbSOSetDefAdvTable"> <?php echo language('common/main/main','tModalAdvUseDefOption')?></div>
<script src="<?php echo base_url(); ?>application/modules/common/assets/js/jquery.tablednd.js"></script>
<script type="text/javascript">
    $(document).ready(function() {
        $("#otbSOOrderListDetail").tableDnD();
    });
</script>