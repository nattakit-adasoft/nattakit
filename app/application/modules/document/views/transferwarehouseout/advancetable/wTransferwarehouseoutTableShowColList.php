            ...
            <?php if(isset($aAvailableColumn) && !empty($aAvailableColumn)):?>
                ...
                <?php foreach($aAvailableColumn as $nAdvTblKey => $aDataAdvTbl):?>
                    ...
                    <?php if($aDataAdvTbl->FTShwNameUsr != '' && $aDataAdvTbl->FTShwFedShw != ""): ?>
                        <tr>
                            <td><?php echo $i;?></td>
                            <td><label contenteditable="true" class="xWTWOLabelColumnName"><?php echo $aDataAdvTbl->FTShwNameUsr;?></label></td>
                            <td class="text-center">
                                <input class="xWTWOInputColStaShow" type="checkbox" <?php echo $tChecked?> data-id="<?php echo $aDataAdvTbl->FTShwFedShw;?>">
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endif; ?>
...
<div style="padding:10px 0px;"><input type="checkbox" id="ocbTWOSetDefAdvTable"> <?php echo language('common/main/main','tModalAdvUseDefOption')?></div>
