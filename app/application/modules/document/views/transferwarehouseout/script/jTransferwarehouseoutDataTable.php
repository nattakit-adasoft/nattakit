<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('.ocbListItem').unbind().click(function(){
            ...
            if(aArrayConvert == '' || aArrayConvert == null){
                ...
                var aReturnRepeat = JStTWOFindObjectByKey(aArrayConvert[0],'nCode',nCode);
            ...
            JSxTWOShowButtonChoose();
        });

        // Confirm Delete Modal Multiple
        $('#odvTWOModalDelDocMultiple #osmConfirmDelMultiple').unbind().click(function(){
            var nStaSession = JCNxFuncChkSessionExpired();
            if (typeof nStaSession !== "undefined" && nStaSession == 1) {
                JSoTWODelDocMultiple();
            }else{
    ...
    //ปุ่มกดลบทั้งหมดเปิด
    function JSxTWOShowButtonChoose() {
        var aArrayConvert = [JSON.parse(localStorage.getItem("LocalItemData"))];
        if (aArrayConvert[0] == null || aArrayConvert[0] == "") {
