    ...
    <table class="table table-striped xWPdtTableFont" style="margin-bottom: 0px;">
        <tbody id="odvTBodyVat">
            ...
            <?php foreach($aDataVatDT AS $value){?> 
                <tr>
                    <td class='text-left xCNTextDetail2'><label class="xCNLabelFrm"><?= language('document/rentalproductpriceadjustmentlocker/rentalproductpriceadjustmentlocker', 'tTFWTBVatName') ?></label></td>
