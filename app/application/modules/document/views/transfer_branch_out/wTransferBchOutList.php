	...
	<div class="panel-body">
		<section id="ostSearchTransferBchOut">
			...
			<div class="row hidden" id="odvTransferBchOutAdvanceSearchContainer" style="margin-bottom:20px;">
				...
				<div class="col-lg-12">
					<a id="oahTFWAdvanceSearchSubmit" class="btn xCNBTNDefult xCNBTNDefult1Btn pull-right" href="javascript:;" onclick="JSvTransferBchOutCallPageDataTable()"><?php echo language('common/main/main', 'tSearch'); ?></a>
				</div>
			</div>
		</section>
	</div>
