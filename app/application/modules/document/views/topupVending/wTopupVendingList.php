	...
	<div class="panel-body">
		<section id="ostSearchPromotion">
			...
			<div class="row hidden" id="odvTFWAdvanceSearchContainer" style="margin-bottom:20px;">
				...
				<div class="col-lg-12">
					<a id="oahTFWAdvanceSearchSubmit" class="btn xCNBTNDefult xCNBTNDefult1Btn pull-right" href="javascript:;" onclick="JSvTopUpVendingCallPagePdtDataTable()"><?php echo language('common/main/main', 'tSearch'); ?></a>
				</div>
			</div>
		</section>
	</div>
