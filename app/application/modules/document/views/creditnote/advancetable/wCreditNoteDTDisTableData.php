...
<script>
    ...
    var cXpdDisChgAvi = $('#ohdFCXpdDisChgAvi').val();
    var cDisSUM = $('#ohdFCXpdDisSUM').val();
    var cChgSUM = $('#ohdFCXpdChgSUM').val();
    var cXpdNet = $('#ohdFCXpdNet').val();

    var tXpdDisChgTxt = $('#ohdFCXpdDisChgTxt').val();
    ...
    function JSnPORemoveDTDisInFile(nIndex) {
        ...
        if (typeof nStaSession !== "undefined" && nStaSession == 1) {
            ...
            var nKey = $('#ohdnKey').val();
            var ptXphDocNo = $('#oetXphDocNo').val();
            var tSeqNo = $('#ohdSeqNo').val();
    ...
    function JSnEditDTDisRow(event) {
        ...
        $('#' + nRowID).each(function (ele) {
            ...
            var tDisTypePanal = $('.xCNDivDTDisTypePanal').html();
            var tDisType = $('#' + nRowID + ' .xWAlwEditXpdDTDisChgType').data('distype');
            var tValue = $('#' + nRowID + ' .xWAlwEditXpdDTDisChgValue').data('disvalue');
    ...
    function JSxDTDisEditSave(event) {
        ...
        if (typeof nStaSession !== "undefined" && nStaSession == 1) {
            ...
            var nSeqNo = $('#ohdSeqNo').val();

            // DT
            var tDTDisChgType = $('#ostDTDisChgType' + tIndex).val();
            var tDTDisChgValue = $('#oetDTDisChgValue' + tIndex).val();

            var nPlusOld = '';
            var nPercentOld = '';
            var tPlusNew = '';
            var nPercentNew = '';
            var tOldDisDTChgLength = '';
            ...
            $('.xWAlwEditXpdDTDisChgValue').each(function (e) {
                if ($(this).text() != '') {
                    var nDistypeOld = $(this).data('distype');
            ...
            var tNewDisDTChgLength = tPlusNew + accounting.formatNumber(tDTDisChgValue, nOptDecimalSave, "") + nPercentNew;
            // เอาทั้งสองมาต่อกัน
            var tCurDisDTChgLength = tOldDisDTChgLength + tNewDisDTChgLength
            // หาจำนวนตัวอักษร
            var nCurDisDTChgLength = tCurDisDTChgLength.length;
