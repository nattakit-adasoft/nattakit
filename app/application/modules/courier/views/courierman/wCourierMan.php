            ...
            <div class="xCNCpgVMaster">
                <div class="col-xs-12 col-md-8">
                    <ol id="oliMenuNav" class="breadcrumb"> <!-- เปลี่ยน -->
                        <?php FCNxHADDfavorite('courierMan/0/0');?> 
                        <li id="oliCpgTitle" class="xCNLinkClick" onclick="JSvCallPageCurmanList()" style="cursor:pointer"><?= language('courier/courierman/courierman','tCRMTitle')?></li> <!-- เปลี่ยน -->
                        <li id="oliCpgTitleAdd" class="active"><a><?= language('courier/courierman/courierman','tCRMAdd')?></a></li>
                        <li id="oliCpgTitleEdit" class="active"><a><?= language('courier/courierman/courierman','tCRMEdit')?></a></li>
                    </ol>
                </div>
                <div class="col-xs-12 col-md-4 text-right p-r-0"> <!-- เปลี่ยน -->
                    <div id="odvBtnCpgInfo">
                        ...
                        <button class="xCNBTNPrimeryPlus" type="button" onclick="JSvCallPageCurmanAdd()">+</button>
                        <?php endif;?>
                    </div>
                    <div id="odvBtnAddEdit">
                        <div class="demo-button xCNBtngroup" style="width:100%;">
                            <button onclick="JSvCallPageCurmanList()" class="btn xCNBTNDefult xCNBTNDefult2Btn" type="button"> <?php echo language('common/main/main', 'tBack')?></button>
                            <?php if($aAlwEventCourierGrp['tAutStaFull'] == 1 || ($aAlwEventCourierGrp['tAutStaAdd'] == 1 || $aAlwEventCourierGrp['tAutStaEdit'] == 1)) : ?>
                            <div class="btn-group">
								<button type="submit" class="btn xWBtnGrpSaveLeft" onclick="$('#obtSubmitCurMan').click()"> <?php echo language('common/main/main', 'tSave')?></button>
								<?php echo $vBtnSave?>
							</div>
                            <?php endif;?>
                        </div>
...
<script src="<?= base_url('application/modules/courier/assets/src/courierman/jCourierman.js')?>"></script>
