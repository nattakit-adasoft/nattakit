...
class Courieraddress_controller extends MX_Controller {

    public function __construct() {
        parent::__construct ();
        $this->load->model('courier/courier/Courieraddress_model');
    }
    ...
    public function FSvCCRYAddressDataTable(){
        ...
        $aCourierDataAddress   = $this->Courieraddress_model->FSaMCourierAddressDataList($aDataWhere);
    ...
    public function FSvCCRYAddressCallPageAdd(){
        ...
        $aCourierDataVersion    = $this->Courieraddress_model->FSaMCourierAddressGetVersion();
        $aDataViewAdd           = [
    ...
    public function FSvCCRYAddressCallPageEdit(){
        ...
        $aCourierDataVersion    = $this->Courieraddress_model->FSaMCourierAddressGetVersion();
        $aDataAddress           = $this->Courieraddress_model->FSaMCourierAddressGetDataID($aDataWhereAddress);
        $aDataViewEdit          = [
    ...
    public function  FSoCCRYAddressAddEvent(){
        try{
            ...
            $this->Courieraddress_model->FSxMCourierAddressAddData($aCourierDataAddress);
            $this->Courieraddress_model->FSxMCourierAddressUpdateSeq($aCourierDataAddress);
    ...
    public function FSoCCRYAddressEditEvent(){
        try{
            ...
            $this->Courieraddress_model->FSxMCourierAddressEditData($aCourierDataAddress);
            $this->Courieraddress_model->FSxMCourierAddressUpdateSeq($aCourierDataAddress);
    ...
    public function FSoCCRYAddressDeleteEvent(){
        try{
            ...
            $this->Courieraddress_model->FSaMCourierAddressDelete($aDataWhereDelete);
            $this->Courieraddress_model->FSxMCourierAddressUpdateSeq($aDataWhereDelete);
