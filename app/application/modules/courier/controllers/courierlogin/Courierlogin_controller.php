...
class Courierlogin_controller extends MX_Controller {

    public function __construct() {
        parent::__construct ();
        $this->load->model('company/branch/Branch_model');
        $this->load->model('courier/courierman/Courierman_model');
        $this->load->model('courier/courierlogin/Courierlogin_model');
    ...
    public function FSvCCURLogDataList(){
        ...
        $aResList   = $this->Courierlogin_model->FSaMCURLDataList($aData);
        $aGenTable  = array(
            'aDataList' 	    => $aResList,
            'nPage'     	    => $nPage,
            'aAlwEventCURL'     => $aAlwEventCURL,
    ...
    public function FSvCCURlogPageEdit(){
        ...
        $aResult        = $this->Courierlogin_model->FSaMCURLCheckID($aData);
    ...
    public function FSaCCURlogAddEvent(){
        try{
            ...
            $oCountDup  = $this->Courierlogin_model->FSoMCURLCheckDuplicate($aDataMaster['FTManLogin']);
            
            if($oCountDup==false){
                $this->db->trans_begin();
                $aStaRsnMaster  = $this->Courierlogin_model->FSaMCURLAddUpdateMaster($aDataMaster);
    ...
    public function FSaCCURlogDeleteEvent(){
        ...
        $aResDel        = $this->Courierlogin_model->FSnMCURLDel($aDataMaster);
        $nNumRowRsnLoc  = $this->Courierlogin_model->FSnMLOCGetAllNumRow();
    ...
    public function FSoCCURLogDelMultipleEvent(){
        try{
            ...
            $tResult = $this->Courierlogin_model->FSaMCURLDeleteMultiple($aDataDelete);
    ...
    function FSaMCURCheckDuplicate(){
        ...
        $aResult  = $this->Courierlogin_model->FSoMCURLCheckDuplicateTel($aData);
