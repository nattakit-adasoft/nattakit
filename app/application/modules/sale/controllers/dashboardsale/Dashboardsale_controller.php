...
class Dashboardsale_controller extends MX_Controller
{
    ...
    {
        $this->FSxCInitParams();
        $this->load->model('sale/dashboardsale/Dashboardsale_model');
    ...
    public function FSvCDSHSALViewTotalSaleByRecive()
    {
        ...
        require_once APPPATH . 'modules/sale/datasources/charttotalsalebyrecive/Charttotalsalebyrecive_controller.php';
        $oChartTotalSaleByRecive    = new Charttotalsalebyrecive_controller(array(
    ...
    public function FSvCDSHSALViewPdtStockBarlance()
    {
        ...
        require_once APPPATH . 'modules/sale/datasources/chartpdtstockbarlance/Chartpdtstockbarlance_controller.php';
        $oChartPdtStockBarlance = new Chartpdtstockbarlance_controller(array(
            'aDataReturn'   => $aInfoDataReder,
            'aTextLang'     => $this->aTextLang
        ));
    ...
    public function FSvCDSHSALViewTotalSaleByPdtGrp()
    {
        ...
        require_once APPPATH . 'modules/sale/datasources/charttotalsalebypdtgrp/Charttotalsalebypdtgrp_controller.php';
        $oChartTotalSaleByPdtGrp    = new Charttotalsalebypdtgrp_controller(array(
            'aDataReturn'   => $aInfoDataReder,
            'aTextLang'     => $this->aTextLang
        ));
    ...
    public function FSvCDSHSALViewTotalSaleByPdtPty()
    {
        ...
        require_once APPPATH . 'modules/sale/datasources/charttotalsalebypdtpty/Charttotalsalebypdtpty_controller.php';
        $oChartTotalSaleByPdtPty    = new Charttotalsalebypdtpty_controller(array(
            'aDataReturn'   => $aInfoDataReder,
            'aTextLang'     => $this->aTextLang
        ));
    ...
    public function FSvCDSHSALViewTopTenBestSaller()
    {
        ...
        require_once APPPATH . 'modules/sale/datasources/charttoptenbestsaller/Charttoptenbestseller_controller.php';
        $oChartToptenBestSeller = new Charttoptenbestseller_controller(array(
            'aDataReturn'   => $aInfoDataReder,
            'aTextLang'     => $this->aTextLang
        ));
    ...
    public function FSvCDSHSALViewTopTenBestSallerByValue()
    {
        ...
        require_once APPPATH . 'modules/sale/datasources/charttoptenbestsallerbyvalue/Charttoptenbestsellerbyvalue_controller.php';
        $oChartToptenBestSellerByValue = new Charttoptenbestsellerbyvalue_controller(array(
            'aDataReturn'   => $aInfoDataReder,
            'aTextLang'     => $this->aTextLang
        ));
    ...
    public function  FSvCDSHSALViewTotalByBranch()
    {
        ...
        $aListData = array(
            'aTotalSaleByBranchData' => $this->Dashboardsale_model->FSaMDSHSALTotalSaleByBranch($aData),
