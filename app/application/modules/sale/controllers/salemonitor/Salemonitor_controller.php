...
class Salemonitor_controller extends MX_Controller {
    ...
    */
    ...
    public function __construct() {
        ...
        $this->FSxCInitParams();
        $this->load->model('sale/salemonitor/Salemonitor_model');
    ...
    public function FSvCSMTCallSaleDataTable(){
        ...
        $aListData = array(
            'aTotalSaleByBranchData' => $this->Salemonitor_model->FSaMSMTSALTotalSaleByBranch($aData),
    ...
    public function FSvCSMTCallApiDataTable(){
        ...
        $aUrlObject = $this->Salemonitor_model->FSaMSMTCallObjectData($aData);
