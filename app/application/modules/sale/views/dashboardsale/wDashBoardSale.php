    ...
    <div id="odvDSHSALMainMenu" class="main-menu">
        <div class="xCNMrgNavMenu">
            <div class="row xCNavRow" style="width:inherit;">
                ...
                <div class="text-right" style="padding:0px;margin-top:0.3rem;">
                    <button id="obtDSHSALConfigPage" type="button" class="btn btn-secondary xCNLabelFrm" data-dismiss="modal"><i class="fa fa-gears"></i></button>
                </div>
