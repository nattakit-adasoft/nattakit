...
class Funcsetting_controller extends MX_Controller {

    public function __construct(){
        parent::__construct ();
        $this->load->model('setting/func_setting/Funcsetting_model');
    }
    ...
    public function FSxCFuncSettingSearchList(){
        ...
        $aSystemApp = $this->Funcsetting_model->FSaMFuncSettingGetSystemAppAll($aGetSystemAppAllParams);
    ...
    public function FSxCFuncSettingGetDataTableInHD(){
        ...
        $aResList = $this->Funcsetting_model->FSaMFuncSetingGetDataHD($aGetDataParams);
    ...
    public function FSxCFuncSettingInsertDTToTemp(){
        ...
        $this->Funcsetting_model->FSaMFuncSettingInsertDTToTemp($aInsertDTToTempParams);
    ...
    public function FSxCFuncSettingGetDataTableInTemp(){
        ...
        $aResList = $this->Funcsetting_model->FSaMFuncSetingGetDataInTemp($aGetDataParams);
    ...
    public function FSxCFuncSettingSaveEvent(){
        ...
        $this->Funcsetting_model->FSaMFuncSettingUpdateTmpToDT($aUpdateTmpToDTParams);
        ...
        $this->Funcsetting_model->FSaMFuncSettingUpdateFuncInHD($aUpdateFuncInHDParams);
        /*===== End Store DB =================================================*/
    ...
    public function FSxCFuncSettingUpdateFuncInTmp(){
        ...
        $this->Funcsetting_model->FSaMFuncSettingUpdateFuncInTmp($aUpdateFuncInTempParams);
