...
class Userlogin_controller extends MX_Controller {

    public function __construct() {
        parent::__construct ();
        $this->load->model('company/branch/Branch_model');
        $this->load->model('authen/user/User_model');
        $this->load->model('authen/userlogin/Userlogin_model');
    ...
    public function FSvCUserLogDataList(){
        ...
        $aResList   = $this->Userlogin_model->FSaMUSRLDataList($aData);
    ...
    public function FSvCUserlogPageEdit(){
        ...
        $aResult    = $this->Userlogin_model->FSaMUSRLCheckID($aData);
    ...
    public function  FSaCUserlogAddEvent(){
        try{    
            ...
            $oCountDup  = $this->Userlogin_model->FSoMUSRLCheckDuplicate($aDataMaster['FTUsrLogin']);

            if($oCountDup==false){
                $this->db->trans_begin();
                $aStaMaster  = $this->Userlogin_model->FSaMUSRLAddUpdateMaster($aDataMaster);

                // ไป update ที่ตาราง TCNMUser
                $this->Userlogin_model->FSaMUSRLAddUpdateLastUp($aDataUpdateLastUp, $aDataMaster);
    ...
    public function FSaCUserlogDeleteEvent(){
        ...
        $aResDel        = $this->Userlogin_model->FSnMUSRLDel($aDataMaster);
        $nNumRowRsnLoc  = $this->Userlogin_model->FSnMLOCGetAllNumRow();
    ...
    public function FSoCUserlogDelMultipleEvent(){
        try{
            ...
            $tResult    = $this->Userlogin_model->FSaMUSRLDeleteMultiple($aDataDelete);
