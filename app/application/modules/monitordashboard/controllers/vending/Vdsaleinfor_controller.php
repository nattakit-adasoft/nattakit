...
class Vdsaleinfor_controller extends MX_Controller {

    public function __construct() {
        parent::__construct ();
        $this->load->model('monitordashboard/vending/Vdsaleinfor_model');
    ...
    public function index(){
        ...
        if($tBranchCom){
            $aBranch = $this->Vdsaleinfor_model->FSxMGetBranchInfor();
            $aMerChant = $this->Vdsaleinfor_model->FSxMGetMerChantInfor($tBranchCom);
            if($aMerChant){
                $aShop = $this->Vdsaleinfor_model->FSxMGetShopInfor($tBranchCom,$aMerChant[0]["FTMerCode"]);
            }else{
                $aShop = false;
            }
        }else{
    ...
    public function FSxCGetMerChantInfor(){
        $aMerChant = $this->Vdsaleinfor_model->FSxMGetMerChantInfor($this->input->post("tBranch"));
        echo json_encode($aMerChant);
    }
    public function FSxCGetShopInfor(){
        $aShop = $this->Vdsaleinfor_model->FSxMGetShopInfor($this->input->post("tBranch"),$this->input->post("tMerChant"));
    ...
    public function FSxCGetInforDashBoard(){
        ...
        $aInforDB = $this->Vdsaleinfor_model->FSxMGetALLGrossSale($aSendToFillter);
        ...
        fclose($oHandle);
        $aNumSaleBill = $this->Vdsaleinfor_model->FSxMGetNumBillSale($aSendToFillter);
        ...
        fclose($oHandle);
        $aNumReturnBill = $this->Vdsaleinfor_model->FSxMGetNumBillReturn($aSendToFillter);
    ...
    public function FSxCLoadPdtBestSale(){
        ...
        $aListBestSalePdt = $this->Vdsaleinfor_model->FSxMGetListBestSalePdt($aFillter);
    ...
    public function FSxCLoadHistoryPosSale(){
        ...
        $aListBestSalePdt = $this->Vdsaleinfor_model->FSxMLoadHistoryPosSale($aFillter);
