...
function FSnHRefunChkStaShiftInCard($paParams){
    ...
    if(!empty($bStaCardShift) && $bStaCardShift === TRUE){
        $tRmkError          =   language('common/docvalidate','tErrorStaCrdShiftNotWithdrawned'); // Add validate for lang (jame) 08/01/2019
        $tWhereStaCrdShift  = " AND CRD.FTCrdStaShift = 1 ";
    }else if(!empty($bStaCardShift) && $bStaCardShift === FALSE){
        $tRmkError          =   language('common/docvalidate','tErrorStaCrdShiftWithdrawned'); // Add validate for lang (jame) 08/01/2019
...
function FSnHRefunChkStaActiveInCard($paParams){
    ...
    switch($nCrdStaActive){
        case '1':
            $tRmkError           =   language('common/docvalidate','tErrorStaCrdActive'); // Add validate for lang (jame) 08/01/2019
            $tWhereCrdStaActive  =  " AND CRD.FTCrdStaActive = 1";
        break;
        case '2':
            $tRmkError           =   language('common/docvalidate','tErrorStaCrdInActive'); // Add validate for lang (jame) 08/01/2019
            $tWhereCrdStaActive  =  " AND CRD.FTCrdStaActive = 2";
        break;
        case '3':
            $tRmkError           =   language('common/docvalidate','tErrorStaCrdCancle'); // Add validate for lang (jame) 08/01/2019
