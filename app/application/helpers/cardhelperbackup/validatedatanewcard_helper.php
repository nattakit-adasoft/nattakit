...
function FSnHNewCrdChkCrdCodeDup($paParams){
    ...
    $tRmkLang   =   language('common/docvalidate','tNewCardDup'); 
    $tSQL   = " UPDATE TFNTCrdImpTmp SET FTCidStaCrd = 2 , FTCidRmk = '".$tRmkLang."'
                ...
                IN(
                    ...
                    LEFT JOIN  TFNMCard CRD ON CIT.FTCidCrdCode = CRD.FTCrdCode
                    WHERE 1 = 1 ";
    $tSQL   .= $tWhereSltSeqNo;
    $tSQL   .= " ) ";
    $tSQL   .= $tWhereUpdSeqNo;
...
function FSnHNewCrdChkCardTypeInDB($paParams){
    ...
    $tErrorCardTypeRmk  = language('common/docvalidate','tErrorCardType');  // Add document validate (Bell) 08/01/2019
    $tSQL   = " UPDATE TFNTCrdImpTmp SET FTCidStaCrd = 2 , FTCidRmk = '".$tErrorCardTypeRmk."'
                ...
                NOT IN(
                    ...
                    (
                        ...
                        FROM TFNTCrdImpTmp CIT
                        LEFT JOIN  TFNMCardType CTY ON CIT.FTCtyCode = CTY.FTCtyCode
...
function FSnHNewCrdChkDepartInDB($paParams){
    ...
    $tErrorUsrDepartRmk  = language('common/docvalidate','tErrorUsrDepart');  // Add document validate (Bell) 08/01/2019
...
function FSnHNewCrdChkCrdCodeNotDupTemp($paParams){
    ...
    $tErrorCrdTmpDup  = language('common/docvalidate','tErrorCrdTmpDup');  // Add document validate (Bell) 08/01/2019
...
function FSnHNewCrdChkCrdNameNotEmpty($paParams){
    ...
    $tErrorCrdNameNotEmpty = language('common/docvalidate','tErrorCrdNameNotEmpty');  // Add document validate (Bell) 08/01/2019
